...
function Legend({ color, label, count, percent }: { color: string; label: string; count: number; percent: number }) {
    return (
        <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
            ...
            <span className="tabular-nums" style={{ fontSize: 12.5, fontWeight: 700, color: "#0f172a" }}>
...
export default function WorkforcePayrollPanel({
    ...
    const trendBackground = trendFlat ? "#f1f5f9" : trendUp ? "#d1fae5" : "#fee2e2";
            ...
            <div>
                ...
                {totalEmployees === 0 ? (
                    ...
                    <>
                        ...
                        >
                            <div style={{ width: `${activePercent}%`, background: ACTIVE_COLOR }} />
                        </div>
                        ...
                        <p style={{ margin: "8px 0 0", fontSize: 12, color: "#94a3b8" }}>
                            {t("hr.dashboard.employmentStatusUnit", { total: totalEmployees.toLocaleString() })}
                        </p>
                    </>
                )}
            </div>
