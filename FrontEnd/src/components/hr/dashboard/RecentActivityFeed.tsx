        ...
        {items.map((item) => (
          ...
          >
            <Avatar
              size={30}
              style={{
                background: actorColor(item.employee),
                fontWeight: 700,
                fontSize: 12,
                flexShrink: 0,
              }}
  ...
  const columns: ColumnsType<HrRecentActivityItem> = [
    ...
    },
    {
      ...
      render: (text: string, record) => (
        <Tag
          ...
          style={{ borderRadius: 20, border: 0, fontWeight: 600, fontSize: 11 }}
        >
      ...
      : []),
    {
      ...
      render: (text: string) => (
        <span
          className="tabular-nums"
          style={{ color: "#94a3b8", fontSize: 12.5, whiteSpace: "nowrap" }}
        >
          {text}
        </span>
      ),
