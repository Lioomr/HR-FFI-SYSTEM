...
function markerFor(
  ...
  if (stageLower.includes("submit"))
    return { color: "#3b82f6", icon: <FileTextOutlined aria-hidden /> };
  if (stageLower.includes("reject") || noteLower.includes("reject")) {
    return { color: "#ef4444", icon: <CloseCircleFilled aria-hidden /> };
  }
  if (stageLower.includes("cancel"))
    return { color: "#6b7280", icon: <CloseCircleFilled aria-hidden /> };
  if (stageLower.includes("deduct"))
    return { color: "#06b6d4", icon: <CheckCircleFilled aria-hidden /> };
