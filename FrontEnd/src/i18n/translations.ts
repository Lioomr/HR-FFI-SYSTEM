...
export const translations: Record<AppLanguage, TranslationMap> = {
  en: {
    ...
    "employee.dashboard.submittedOn": "Submitted",
    "employee.dashboard.intro":
      "Your requests, work records, and everyday essentials in one place.",
    "employee.dashboard.selfService": "EMPLOYEE SELF-SERVICE",
    "employee.dashboard.requestsTitle": "What would you like to request?",
    "employee.dashboard.requestsHint":
      "Start a new request or follow the progress of one you’ve already submitted.",
    "employee.dashboard.newRequest": "New request",
    "employee.dashboard.trackRequests": "Track my requests",
    ...
    "employee.dashboard.servicesHint":
      "Find your records and manage your workday.",
    "employee.dashboard.searchServices": "Find a service, e.g. payslips",
    "employee.dashboard.attendance": "My attendance",
    "employee.dashboard.attendanceHint":
      "Review your attendance records and working hours.",
    "employee.dashboard.balance": "Leave balance",
    "employee.dashboard.balanceHint":
      "Check available days before planning your next leave.",
    "employee.dashboard.corrections": "Attendance corrections",
    "employee.dashboard.correctionsHint":
      "Request a correction and track previous submissions.",
    "employee.dashboard.assets": "My assets",
    "employee.dashboard.assetsHint":
      "View equipment and assets assigned to you.",
    "employee.dashboard.delegated": "Delegated approvals",
    "employee.dashboard.delegatedHint":
      "Review leave requests delegated to you for approval.",
    "employee.dashboard.noServices": "No services match your search.",
    "employee.dashboard.clearSearch": "Show all services",
    ...
    "layout.organizationSetup": "Organization Setup",
    ...
    "layout.teamPermissionRequests": "Team Permission Requests",
    ...
    "layout.nav.alternateApprovals": "Alternate Approvals",
    "layout.nav.alternatesSetup": "Alternates Setup",
    "layout.nav.leaveSettlements": "Leave Settlements",
    "layout.nav.permissionInbox": "Permission Inbox",
    "layout.nav.myPermissions": "My Permissions",
    "layout.nav.leaveApprovals": "Leave Approvals",
    "layout.nav.biotimeSettings": "BioTime Settings",
    "layout.nav.whatsapp": "WhatsApp",
    "layout.nav.myAttendance": "My Attendance",
    "layout.menu.hiring": "Hiring",
    "layout.menu.payrollAssets": "Payroll & Assets",
    "layout.menu.communication": "Communication",
    "layout.nav.requestQueues": "Request Queues",
    ...
    "error.unauthorized.redirecting":
      "Redirecting you to the home page ({seconds})…",
    ...
    "employee.dashboard.permissionTitle": "Exit Permission",
    ...
    "permissionRequests.form.toTime": "To time",
    "permissionRequests.form.exitType": "Exit type",
    "permissionRequests.form.reason": "Reason",
    ...
    "permissionRequests.list.all": "All statuses",
    "permissionRequests.list.reference": "Reference",
    "permissionRequests.list.employee": "Employee",
    "permissionRequests.list.date": "Date",
    "permissionRequests.list.time": "Time",
    "permissionRequests.list.type": "Type",
    "permissionRequests.list.status": "Status",
    "permissionRequests.list.empty": "No permission requests found.",
    "permissionRequests.detail.downloadPdf": "Download PDF",
    "permissionRequests.detail.employee": "Employee",
    "permissionRequests.detail.date": "Date",
    "permissionRequests.detail.time": "Time",
    "permissionRequests.detail.duration": "{minutes} minutes",
    "permissionRequests.detail.exitType": "Exit type",
    "permissionRequests.detail.reason": "Reason",
    "permissionRequests.detail.directManager": "Direct manager",
    "permissionRequests.detail.decisionComment": "Optional decision comment",
    "permissionRequests.detail.approve": "Approve",
    "permissionRequests.detail.reject": "Reject",
    "permissionRequests.detail.cancel": "Cancel request",
    "permissionRequests.detail.cancelTitle": "Cancel this request?",
    "permissionRequests.detail.history": "Workflow history",
    "permissionRequests.detail.system": "System",
    "permissionRequests.detail.none": "Not assigned",
    "permissionRequests.detail.trail": "Approval trail",
    "permissionRequests.detail.submitted": "Submitted",
    "permissionRequests.detail.managerStage": "Direct Manager Approval",
    "permissionRequests.detail.hrStage": "HR Approval",
    "permissionRequests.detail.approver": "Approver: {name}",
    "permissionRequests.detail.pending": "Pending",
    "permissionRequests.detail.completed": "Completed",
    "permissionRequests.detail.skipped": "Skipped",
    "permissionRequests.detail.notRequired": "Not required for this employee",
    "permissionRequests.detail.cancelledStage": "Cancelled",
    "permissionRequests.detail.approvedDecision": "Approved",
    "permissionRequests.detail.rejectedDecision": "Rejected",
    "permissionRequests.history.submit": "Submitted",
    "permissionRequests.history.advance": "Advanced",
    "permissionRequests.history.approve": "Approved",
    "permissionRequests.history.reject": "Rejected",
    "permissionRequests.history.cancel": "Cancelled",
    "permissionRequests.status.pendingManager": "Pending Manager",
    "permissionRequests.status.pendingHr": "Pending HR",
    "permissionRequests.status.approved": "Approved",
    "permissionRequests.status.rejected": "Rejected",
    "permissionRequests.status.cancelled": "Cancelled",
    "permissionRequests.error.load": "Unable to load permission requests.",
    "permissionRequests.error.submit": "Unable to submit the request.",
    "permissionRequests.error.action": "Unable to update the request.",
    "permissionRequests.error.pdf": "Unable to download the PDF.",
    "permissionRequests.error.unauthorized":
      "Your session has expired. Please sign in again.",
    "permissionRequests.error.forbidden":
      "You are not allowed to perform this action.",
    "permissionRequests.error.notFound":
      "This permission request was not found or is no longer visible.",
    "permissionRequests.error.network":
      "A network error occurred. Please try again.",
    "permissionRequests.error.retry": "Retry",
    "permissionRequests.success.submitted": "Permission request submitted.",
    "permissionRequests.success.updated": "Permission request updated.",
    "permissionRequests.success.cancelled": "Permission request cancelled.",
    ...
    "hr.dashboard.welcome": "Welcome, {name}",
    "hr.dashboard.todaySummary": "Today's HR summary — {organization}",
    "hr.dashboard.todaySummaryNoOrg": "Today's HR summary",
    "header.today": "Today",
    ...
    "hr.dashboard.workforceStatus": "Workforce status",
    "hr.dashboard.workforceStatusDesc": "Where employees are today",
    "hr.dashboard.status.currentlyEmployed": "Currently employed",
    "hr.dashboard.status.onLeaveOutside": "On leave – outside the country",
    "hr.dashboard.status.onLeaveInside": "On leave – inside the country",
    "hr.dashboard.activeInactive": "{active} active · {inactive} inactive",
    "hr.dashboard.expiringDocsTitle": "Expiring documents",
    "hr.dashboard.expiringDocsDesc": "{count} employees · next {days} days",
    "hr.dashboard.docGroup.national_id": "National ID",
    "hr.dashboard.docGroup.iqama": "Iqama",
    "hr.dashboard.docGroup.passport": "Passport",
    "hr.dashboard.docGroup.work_license": "Work license",
    "hr.dashboard.docGroup.contract": "Contract",
    ...
    "hr.dashboard.employeesTotal": "Employees",
    "hr.dashboard.nationality": "Employees by nationality",
    "hr.dashboard.nationalityDesc": "Current employees, excluding archived",
    "hr.dashboard.otherNationalities": "Other nationalities ({count})",
    "hr.dashboard.nationalityUnknown": "Not specified",
    "hr.dashboard.saudizationCaption": "Saudization rate of active employees",
    "hr.dashboard.otherStatuses": "Other statuses",
    ...
    "leave.hrCancelTitle": "Cancel this leave request?",
    "leave.hrCancelDesc":
      "The employee will be notified. Give the reason for cancelling.",
    "leave.hrCancelReasonPlaceholder": "Why is this request being cancelled?",
    "leave.hrCancelReasonRequired": "Enter the reason for cancelling.",
    "leave.hrCancelSuccess": "Leave request cancelled",
    "leave.hrCancelFail": "Could not cancel the leave request",
    "leave.annual": "Annual",
    "leave.sick": "Sick",
    ...
    "attendancePreview.overview": "Overview",
    "attendancePreview.filters.title": "Filters",
    "attendancePreview.resultsCount": "{count} records",
    "attendancePreview.status.present": "Present",
    "attendancePreview.status.absent": "Absent",
    "attendancePreview.status.excused": "Excused absence",
    "attendancePreview.status.lateExcused": "Excused late arrival",
    "attendancePreview.approvedLeaveReference": "Approved leave",
    ...
    "attendancePreview.columns.lateBy": "Late by",
    ...
    "attendancePreview.lateArrivalTag": "Late arrival",
    "attendancePreview.summary.attendanceRate": "Attendance rate",
    "attendancePreview.export.button": "Export",
    "attendancePreview.export.empty":
      "No records to export for the current filters.",
    "attendancePreview.export.failed": "Couldn't export attendance records.",
    "attendancePreview.export.capped":
      "Export limited to the first {max} rows. Narrow the date range for the rest.",
    ...
    "admin.settings.secAttendance": "Attendance",
    "admin.settings.lblGeofenceEnabled": "Require GPS location for check-in",
    "admin.settings.helpGeofenceEnabled":
      "When enabled, employees must be inside an approved work location to check in or out from the mobile app.",
    "admin.settings.lblWorkDayStart": "Work day start time",
    "admin.settings.helpWorkDayStart":
      "A check-in after this time plus the grace period is recorded as Late.",
    "admin.settings.lblLateGraceMinutes": "Late grace period (minutes)",
    "admin.settings.helpLateGraceMinutes":
      "Minutes past the start time before a check-in counts as Late (0–240).",
    ...
    "workLocations.subtitle":
      "Approved sites where employees may record mobile attendance.",
    "workLocations.addButton": "Add Work Location",
    "workLocations.loading": "Loading work locations…",
    "workLocations.loadFailed": "Failed to load work locations.",
    "workLocations.loadFailedTitle": "Could not load work locations",
    "workLocations.emptyTitle": "No work locations yet",
    "workLocations.emptyDescription":
      "Add a site to define where mobile attendance is allowed for this company.",
    "workLocations.createTitle": "Add Work Location",
    "workLocations.editTitle": "Edit Work Location",
    "workLocations.createSuccess": "Work location created.",
    "workLocations.createFailed": "Failed to create the work location.",
    "workLocations.updateSuccess": "Work location updated.",
    "workLocations.updateFailed": "Failed to update the work location.",
    "workLocations.deleteSuccess": "Work location removed.",
    "workLocations.deleteFailed": "Failed to remove the work location.",
    "workLocations.deleteConfirmTitle": "Remove this work location?",
    "workLocations.deleteConfirmDescription":
      "{name} will no longer accept mobile attendance. This can be recreated later.",
    "workLocations.editAria": "Edit {name}",
    "workLocations.deleteAria": "Remove {name}",
    "workLocations.column.name": "Name",
    "workLocations.column.latitude": "Latitude",
    "workLocations.column.longitude": "Longitude",
    "workLocations.column.radius": "Radius",
    "workLocations.column.company": "Company",
    "workLocations.field.name": "Site name",
    "workLocations.field.latitude": "Latitude",
    "workLocations.field.longitude": "Longitude",
    "workLocations.field.radius": "Radius",
    "workLocations.rule.nameRequired": "Please enter a site name",
    "workLocations.rule.nameMax": "Name must be 120 characters or fewer",
    "workLocations.rule.latitudeRequired": "Please enter a latitude",
    "workLocations.rule.longitudeRequired": "Please enter a longitude",
    "workLocations.rule.radiusRequired": "Please enter a radius in metres",
    "workLocations.placeholder.name": "e.g. Riyadh Main Office",
    "workLocations.placeholder.paste": "Paste coordinates, then press Enter",
    "workLocations.pickerHint":
      "Capture the site coordinates, or paste a latitude and longitude pair.",
    "workLocations.useCurrentLocation": "Use my current location",
    "workLocations.geolocationUnsupported":
      "This browser does not support location capture.",
    "workLocations.geolocationCaptured": "Coordinates captured.",
    "workLocations.geolocationFailed":
      "Could not read your location. Allow location access or enter the coordinates manually.",
    "workLocations.pasteInvalid":
      "Could not read a latitude and longitude from that text.",
    "workLocations.pasteApplied": "Coordinates applied.",
    "workLocations.pasteAria": "Paste latitude and longitude",
    "workLocations.metresUnit": "m",
    "workLocations.metresValue": "{value} m",
    "workLocations.companyScopeNote":
      "The site is saved to the company currently selected in the header.",
    "workLocations.headOfficeNotice":
      "Switch to a company to manage its work locations.",
    "workLocations.map.placeholder":
      "Enter a latitude and longitude, paste coordinates, or use your current location to show the map.",
    "workLocations.map.ariaLabel":
      "Work location map. Click the map or drag the marker to set the site centre.",
    "workLocations.map.markerAlt": "Work site centre",
    "workLocations.map.privacyHint":
      "The map only sets the work-site centre. Only the final coordinates and the chosen radius are saved — no map view, address, or employee location data.",
    ...
    "reference.departments.entity": "Department",
    ...
    "reference.positions.entity": "Position",
    "reference.positions.create": "Create Position",
    "reference.taskGroups.title": "Task Groups",
    "reference.taskGroups.entity": "Task Group",
    "reference.sponsors.title": "Sponsors",
    "reference.sponsors.entity": "Sponsor",
    "reference.noItemsFound": "No {entity} found.",
    "reference.itemsCount": "{count} records",
    "reference.setup.subtitle":
      "Manage the departments, positions, task groups and sponsors used across employee records.",
    ...
    "hr.employees.balances.totalBalance": "Total Balance",
    "hr.employees.balances.availableAnnualYearDays":
      "Available Annual Year Days",
    "hr.employees.balances.accruedThisYear": "Accrued This Year",
    "hr.employees.balances.used": "Used",
    "hr.employees.balances.pending": "Pending",
    "hr.employees.balances.availableToRequest": "Available to Request",
    "hr.employees.balances.remaining": "Remaining",
    "hr.employees.balances.adjustments": "Adjustments",
    ...
    "manager.requests.loansTab": "Loans",
    "manager.requests.permissionsTab": "Permissions",
    ...
    "pendingInbox.needsAttention": "Needs your attention",
    "pendingInbox.allClear": "All clear",
    "pendingInbox.searchPlaceholder": "Search by name...",
    "pendingInbox.filterAll": "All",
    "pendingInbox.noMatches": "No pending requests match this filter",
    "pendingInbox.waitingLong": "Waiting more than 3 days",
    ...
    "pendingInbox.requestType.CONTRACT_DECISION": "Contract Decision",
    "pendingInbox.requestType.CONTRACT_RATING": "Contract Rating",
    "pendingInbox.requestType.ANNUAL_LEAVE_PAYMENT": "Annual Leave Settlement",
    ...
    "layout.contractDecisions": "Contract Decisions",
    "contractDecisions.title": "Contract decisions",
    "contractDecisions.subtitle": "Manage upcoming contract expiries.",
    "contractDecisions.detailTitle": "Contract decision",
    "contractDecisions.employee": "Employee",
    "contractDecisions.employeeId": "Employee ID",
    "contractDecisions.expiry": "Contract expiry",
    "contractDecisions.originalExpiry": "Original expiry",
    "contractDecisions.proposedExpiry": "Proposed expiry",
    "contractDecisions.status": "Status",
    "contractDecisions.submitted": "Submitted",
    "contractDecisions.decision": "Decision",
    "contractDecisions.ceoDeadline": "CEO deadline",
    "contractDecisions.hrComment": "HR comment",
    "contractDecisions.failure": "Failure",
    "contractDecisions.takeAction": "Take action",
    "contractDecisions.hrModalTitle": "Submit HR contract decision",
    "contractDecisions.ceoModalTitle": "CEO decision",
    "contractDecisions.renew": "Renew",
    "contractDecisions.renewChanges": "Renew with changes",
    "contractDecisions.terminate": "Terminate",
    "contractDecisions.newStart": "New contract date",
    "contractDecisions.newExpiry": "New contract expiry",
    "contractDecisions.termsHint":
      "For renewal with changes, enter only the salary or allowance fields that should change.",
    "contractDecisions.commentPlaceholder": "Optional comment",
    "contractDecisions.submit": "Submit to CEO",
    "contractDecisions.approve": "Approve",
    "contractDecisions.reject": "Reject",
    "contractDecisions.submitSuccess": "Decision submitted to the CEO.",
    "contractDecisions.approveSuccess": "Contract decision approved.",
    "contractDecisions.rejectSuccess": "Contract decision rejected.",
    "contractDecisions.autoRenewed":
      "This contract was automatically renewed because HR took no action.",
    "contractDecisions.notifications": "Notification status",
    "contractDecisions.filter": "Show",
    "contractDecisions.pendingHr": "Awaiting HR action",
    "contractDecisions.pendingCeo": "Pending CEO approval",
    "contractDecisions.approved": "Approved",
    ...
    "executive.annualLeave": "Annual Leave Payments",
    "executive.partial":
      "Some counts could not be loaded. The total includes available queues only.",
    "executive.unavailable":
      "Count unavailable. Open the queue or refresh to try again.",
    "executive.notificationsFailed": "Notifications could not be loaded.",
    "executive.noUnread": "No unread notifications",
    ...
    "notifications.group.lastWeek": "Last 7 days",
    ...
    "layout.startingWorkAcknowledgments": "BioTime Verifications",
    ...
    "jobOffers.action.previewPdf": "Preview PDF",
    ...
    "jobOffers.detail.section.applicant": "Applicant Details",
    ...
    "jobOffers.pdf.previewFailed": "Could not open the job offer PDF preview.",
    ...
    // CEO approval gate — the offer reaches the candidate only after approval
    "jobOffers.approval.status.all": "All approvals",
    "jobOffers.approval.status.draft": "Not submitted",
    "jobOffers.approval.status.pending_ceo": "Pending CEO",
    "jobOffers.approval.status.approved": "CEO approved",
    "jobOffers.approval.status.changes_requested": "Changes requested",
    "jobOffers.approval.status.rejected": "CEO rejected",
    "jobOffers.approval.awaitingDecision": "Waiting for the CEO decision.",
    "jobOffers.approval.notSubmitted":
      "This offer has not been sent to the CEO yet.",
    "jobOffers.approval.approvedBy": "Approved by {name}",
    "jobOffers.approval.changesRequestedBy": "Changes requested by {name}",
    "jobOffers.approval.rejectedBy": "Rejected by {name}",
    "jobOffers.approval.changesRequestedTitle": "The CEO asked for changes",
    "jobOffers.approval.reason": "Reason",
    "jobOffers.approval.reasonRequired": "Write a reason before continuing.",
    "jobOffers.approval.recommendation": "Recommendation for HR",
    "jobOffers.approval.recommendationHint":
      "Optional guidance HR will see with the decision.",
    "jobOffers.approval.sendBlocked":
      "The offer can only be sent to the candidate after the CEO approves it.",
    "jobOffers.approval.requestChanges": "Request Changes",
    "jobOffers.approval.requestChangesTitle": "Return this offer to HR",
    "jobOffers.approval.rejectTitle": "Reject this job offer",
    "jobOffers.approval.approveSuccess": "Job offer approved.",
    "jobOffers.approval.approveFailed": "Could not approve the job offer.",
    "jobOffers.approval.rejectSuccess": "Job offer rejected.",
    "jobOffers.approval.rejectFailed": "Could not reject the job offer.",
    "jobOffers.approval.requestChangesSuccess": "Job offer returned to HR.",
    "jobOffers.approval.requestChangesFailed":
      "Could not return the job offer to HR.",
    "jobOffers.col.approvalStatus": "CEO Approval",
    "jobOffers.col.reference": "Reference",
    "jobOffers.col.submittedAt": "Submitted",
    "jobOffers.filterApprovalStatus": "CEO approval status",
    "jobOffers.action.downloadCv": "Download CV",
    "jobOffers.action.previewCv": "Preview CV",
    "jobOffers.action.resubmitToCeo": "Resubmit to CEO",
    "jobOffers.action.review": "Review",
    "jobOffers.form.section.cv": "Candidate CV",
    "jobOffers.form.submitToCeo": "Submit to CEO",
    "jobOffers.form.cvDropzone": "Drop the CV here, or click to choose a file",
    "jobOffers.form.cvHint": "PDF, DOC, DOCX, JPG or PNG. Up to 5 MB.",
    "jobOffers.form.cvTooLarge": "The CV must be 5 MB or smaller.",
    ...
    "jobOffers.form.cvRequiredForSubmit":
      "Attach a CV before submitting to the CEO.",
    "jobOffers.form.cvAlreadyAttached":
      "A CV is already attached. Upload another file only to replace it.",
    "jobOffers.field.dateOfBirth": "Date of Birth",
    "jobOffers.field.company": "Company",
    "jobOffers.submit.confirmTitle": "Submit this offer to the CEO?",
    "jobOffers.submit.confirmBody":
      "The CEO is notified and the offer cannot be edited until they respond.",
    "jobOffers.submit.success": "Job offer submitted for CEO approval.",
    "jobOffers.submit.failed": "Could not submit the job offer.",
    "jobOffers.cv.downloaded": "CV downloaded.",
    "jobOffers.cv.failed": "Could not download the CV.",
    "jobOffers.cv.previewUnavailable":
      "This CV can't be previewed in the browser, so it was downloaded instead.",
    "jobOffers.detail.section.ceoReview": "CEO Review",
    ...
    "jobOffers.workflow.action.reject": "Rejected",
    "jobOffers.workflow.action.cancel": "Cancelled",
    "jobOffers.workflow.action.advance": "Advanced to the next stage",
    "jobOffers.workflow.action.reassign": "Reassigned",
    "jobOffers.workflow.action.override": "Overridden",
    "jobOffers.ceo.title": "Job Offers",
    "jobOffers.ceo.subtitle": "Approve offers before they reach the candidate.",
    "jobOffers.ceo.emptyTitle": "Nothing to decide",
    "jobOffers.ceo.emptyDescription": "No job offers in this status.",
    "jobOffers.ceo.backToInbox": "Back to Job Offers",
    "jobOffers.ceo.decisionTitle": "Your decision",
    "jobOffers.ceo.decisionHint":
      "Approving lets HR send the offer to the candidate. Returning it or rejecting it needs a reason.",
    "jobOffers.ceo.noActionAvailable": "This offer is not waiting on you.",
    "jobOffers.ceo.section.candidate": "Candidate",
    "jobOffers.ceo.section.commercialTerms": "Commercial Terms",
    "jobOffers.ceo.editTerms": "Edit Commercial Terms",
    "jobOffers.ceo.editTermsHint":
      "You can change the package, benefits, contract terms, dates, position, department and location. Candidate details and the CV stay with HR.",
    "jobOffers.ceo.saveTerms": "Save Terms",
    "jobOffers.ceo.termsSaved": "Commercial terms updated.",
    ...
    "startingWork.title": "BioTime Verifications",
    "startingWork.subtitle":
      "Verify each employee's first BioTime attendance before it counts as worked time.",
    "startingWork.countTag": "{count} records",
    "startingWork.filterStatus": "Status",
    "startingWork.status.pending_hr": "Pending HR Verification",
    "startingWork.status.approved": "Approved",
    "startingWork.status.rejected": "Rejected",
    "startingWork.col.employee": "Employee",
    "startingWork.col.employeeId": "Employee ID",
    "startingWork.col.firstBiotimeDate": "First BioTime Date",
    "startingWork.col.status": "Status",
    "startingWork.col.affectedAttendance": "Affected Attendance",
    "startingWork.col.generatedAt": "Generated",
    "startingWork.col.actions": "Actions",
    "startingWork.pendingRowNote":
      "Attendance is held from payroll until HR approval.",
    "startingWork.pendingExplanation":
      "This employee's BioTime attendance will not count as worked time for payroll until HR approves it.",
    "startingWork.rejectedExplanation":
      "The affected BioTime attendance records are marked absent until HR approves a corrected verification.",
    "startingWork.approvalAfterRejectionExplanation":
      "Approval restores eligible system attendance records to present. HR corrections are preserved.",
    "startingWork.action.view": "View",
    "startingWork.action.refresh": "Refresh",
    "startingWork.action.back": "Back to BioTime Verifications",
    "startingWork.action.download": "Download Acknowledgment",
    "startingWork.action.approve": "Approve BioTime Verification",
    "startingWork.action.reject": "Reject Verification",
    "startingWork.loadFailed": "Could not load BioTime verifications.",
    "startingWork.detail.loadFailed":
      "Could not load this BioTime verification.",
    "startingWork.detail.notFound": "This BioTime verification was not found.",
    "startingWork.empty.title": "No BioTime verifications yet",
    "startingWork.empty.description":
      "Acknowledgements appear here once an employee records a first BioTime attendance.",
    "startingWork.empty.filteredTitle": "No verifications match this filter",
    "startingWork.empty.filteredDescription": "Try another status.",
    "startingWork.section.record": "Verification Record",
    "startingWork.section.employee": "Employee",
    "startingWork.section.decision": "HR Decision",
    "startingWork.section.history": "Workflow History",
    "startingWork.field.employee": "Employee",
    "startingWork.field.employeeId": "Employee ID",
    "startingWork.field.company": "Company",
    "startingWork.field.firstBiotimeDate": "First BioTime attendance date",
    "startingWork.field.referenceNumber": "Reference number",
    "startingWork.field.affectedAttendance": "Affected attendance records",
    "startingWork.field.generatedAt": "Generated at",
    "startingWork.field.status": "Status",
    "startingWork.field.approvedBy": "Approved by",
    "startingWork.field.approvedAt": "Approved at",
    "startingWork.field.rejectedBy": "Rejected by",
    "startingWork.field.rejectedAt": "Rejected at",
    "startingWork.field.rejectionReason": "Rejection reason",
    "startingWork.decision.none": "No HR decision has been recorded yet.",
    "startingWork.approve.confirmTitle": "Approve this BioTime verification?",
    "startingWork.approve.success": "BioTime verification approved.",
    "startingWork.approve.failed":
      "Could not approve this BioTime verification.",
    "startingWork.reject.reason": "Rejection reason",
    "startingWork.reject.reasonPlaceholder":
      "BioTime attendance could not be verified.",
    "startingWork.reject.reasonRequired": "A rejection reason is required.",
    "startingWork.reject.success": "BioTime verification rejected.",
    "startingWork.reject.failed": "Could not reject this BioTime verification.",
    "startingWork.pdf.success": "Acknowledgment downloaded.",
    "startingWork.pdf.failed": "Could not download the acknowledgment.",
    "startingWork.pdf.approvedNote":
      "The approved acknowledgment PDF records the approving HR user and the approval date.",
    "startingWork.workflow.empty": "No workflow history yet.",
    "startingWork.workflow.currentStage": "Current stage",
    "startingWork.workflow.currentActor": "Current approver",
    "startingWork.workflow.action.submit": "Submitted",
    "startingWork.workflow.action.approve": "Approved",
    "startingWork.workflow.action.reject": "Rejected",

    // Asset return workflow & asset statuses
    "assets.approvalMap.eyebrow": "Asset Return Workflow",
    "assets.approvalMap.title": "Approval Progress",
    "assets.approvalMap.submitted": "Submitted",
    "assets.approvalMap.requestSent": "Return request submitted.",
    "assets.approvalMap.managerReview": "Manager Review",
    "assets.approvalMap.notRequired": "Not required",
    "assets.approvalMap.hrReview": "HR Review",
    "assets.approvalMap.approvedForReturn": "Ready for HR processing.",
    "assets.approvalMap.ceoReview": "CEO Review",
    "assets.approvalMap.processed": "Return Processed",
    "assets.approvalMap.returnCompleted": "Asset return has been processed.",
    "assets.approvalMap.awaitingHandOff":
      "Waiting for HR to receive the asset.",
    "assets.returnRequest": "Return Request",
    "assets.returnRequested": "Return request submitted",
    "assets.returnRequestApproved": "Return request approved",
    "assets.returnRequestRejected": "Return request rejected",
    "assets.searchPlaceholder": "Search by asset code, serial number, or name",
    "assets.requestsHistory": "Request History",
    "assets.filterRequestsByAsset": "Filter by asset",
    "assets.allAssets": "All assets",
    "assets.requestHistoryUnavailable": "Unable to load request history",
    ...
    "assets.status.DAMAGED": "Damaged",
    "assets.status.RETIRED": "Retired",
    "assets.requestStatus.PENDING_MANAGER": "Pending Manager",
    "assets.requestStatus.PENDING": "Pending",
    "assets.requestStatus.PENDING_HR": "Pending HR",
    "assets.requestStatus.PENDING_CEO": "Pending CEO",
    "assets.requestStatus.APPROVED": "Approved",
    "assets.requestStatus.PROCESSED": "Processed",
    "assets.requestStatus.REJECTED": "Rejected",
    "hr.assets.lookup.invalidLabel": "Invalid or expired asset label.",
    "hr.assets.nameEnPlaceholder": "Name (English)",
    "hr.assets.removeCustomDetail": "Remove custom detail",

    // Generic workflow
    "workflow.noUpdate": "No update yet",
    "workflow.currentAction": "Awaiting action",
    "workflow.systemActor": "System",
    "workflow.approvalNotePlaceholder": "Add approval note",
    "workflow.action.submit": "Submitted",
    "workflow.action.approve": "Approved",
    "workflow.action.reject": "Rejected",
    "workflow.action.cancel": "Cancelled",
    "workflow.action.request_changes": "Changes requested",
    "workflow.action.advance": "Advanced",
    "workflow.action.reassign": "Reassigned",
    "workflow.action.override": "Overridden",
    "workflow.action.delegate": "Delegated",

    // Shared UI
    "archive.extractionQueued": "Document extraction queued.",
    "archive.runExtraction": "Run OCR extraction",
    "layout.whatsappIntegration": "WhatsApp Integration",
    ...
    "common.rateLimited": "Please wait before trying again.",
    "common.currency.sar": "Saudi Riyal",
    "common.error.unknown": "An unknown error occurred",
    "common.error.internalServer":
      "An internal server error occurred. Please try again later.",
    "common.error.checkInput": "Please check your input and try again.",
    "common.error.unexpectedResponse":
      "An unexpected server response occurred.",
    "common.error.unexpected": "An unexpected error occurred",
    "common.error.requestFailed": "API request failed",
    "error.loadData": "Failed to load data",
    "error.renderFailed":
      "An unexpected error occurred while rendering this page.",
    "error.reloadPage": "Reload Page",
    "error.technicalDetails": "Technical Details",
    "loading.checkingAccess": "Checking access...",
    "loading.verifyingSession": "Verifying session...",

    // Admin: users, audit, invites
    "admin.users.readOnly": "Read-only",
    "admin.users.companyAccess": "Company Access",
    "admin.users.companyAccessHint":
      "Select the companies and head office contexts this user can switch between.",
    "admin.users.selectCompanies": "Select companies",
    "admin.users.allCompanies": "All companies",
    "admin.users.noCompanyAccess": "No company access",
    "admin.users.manageCompanies": "Manage",
    "admin.users.manageCompaniesTitle": "Manage Companies",
    "admin.users.manageCompaniesFor": "Manage company access for",
    "admin.users.allStatuses": "All statuses",
    "admin.users.countOne": "1 user",
    "admin.users.countOther": "{count} users",
    "admin.users.resetModeTemporary": "Temporary password",
    "admin.users.resetModeLink": "Reset link token",
    ...
    "admin.audit.exported": "Exported {format}.",
    "admin.audit.exportFailed": "Failed to export {format}.",
    "admin.invites.sendFailed": "Failed to send invite.",
    "admin.invites.sentSuccess": "Invite sent successfully.",
    "admin.invites.channelLabelWhatsapp": "WhatsApp message",
    "admin.invites.channelLabelEmail": "email",
    "admin.invites.createdNotDelivered":
      "Invite created, but {channel} was not delivered.",
    "admin.invites.createdNotDeliveredWithError":
      "Invite created, but {channel} was not delivered: {error}",
    "admin.invites.updatedNotDelivered":
      "Invite updated, but {channel} was not delivered.",
    "admin.invites.updatedNotDeliveredWithError":
      "Invite updated, but {channel} was not delivered: {error}",
    "admin.invites.resending": "Resending invite...",
    "admin.invites.resendFailed": "Failed to resend.",
    "admin.invites.resent": "Invite resent.",
    "admin.invites.revoking": "Revoking invite...",
    "admin.invites.revokeFailed": "Failed to revoke.",
    "admin.invites.revoked": "Invite revoked.",

    // Admin: WhatsApp integration
    "admin.whatsapp.subtitle": "Evolution API device pairing and delivery test",
    "admin.whatsapp.status.checking": "Checking",
    "admin.whatsapp.status.notConfigured": "Not configured",
    "admin.whatsapp.status.connected": "Connected",
    "admin.whatsapp.status.open": "Connected",
    "admin.whatsapp.status.disconnected": "Disconnected",
    "admin.whatsapp.status.close": "Disconnected",
    "admin.whatsapp.status.connecting": "Connecting",
    "admin.whatsapp.status.qr": "Waiting for QR scan",
    "admin.whatsapp.status.unreachable": "Unreachable",
    "admin.whatsapp.loadStatusFailed": "Could not load WhatsApp status.",
    "admin.whatsapp.noQrReturned":
      "No QR code returned. Refresh status in a few seconds.",
    "admin.whatsapp.connectFailed": "Could not start WhatsApp connection.",
    "admin.whatsapp.noQrAvailable": "No QR code is available right now.",
    "admin.whatsapp.refreshQrFailed": "Could not refresh QR code.",
    "admin.whatsapp.disconnected": "WhatsApp device disconnected.",
    "admin.whatsapp.disconnectFailed": "Could not disconnect WhatsApp device.",
    "admin.whatsapp.devicePairing": "Device pairing",
    "admin.whatsapp.instance": "Instance: {name}",
    "admin.whatsapp.notSet": "Not set",
    "admin.whatsapp.generateQr": "Generate QR",
    "admin.whatsapp.refreshQr": "Refresh QR",
    "admin.whatsapp.qrAlt": "WhatsApp pairing QR",
    "admin.whatsapp.deviceConnected": "Device is connected",
    "admin.whatsapp.generateQrPrompt": "Generate a QR code",
    "admin.whatsapp.canSend": "WhatsApp notifications can be sent.",
    "admin.whatsapp.scanHint": "Scan the QR code from WhatsApp Linked devices.",
    "admin.whatsapp.disconnectDevice": "Disconnect device",
    "admin.whatsapp.configuration": "Configuration",
    "admin.whatsapp.apiUrl": "API URL",
    "admin.whatsapp.apiKey": "API key",
    "admin.whatsapp.set": "Set",
    "admin.whatsapp.missing": "Missing",
    "admin.whatsapp.providerStatus": "Provider status",
    "admin.whatsapp.sendTestTitle": "Send test",
    "admin.whatsapp.phoneRequired": "Enter a phone number in E.164 format.",
    "admin.whatsapp.sendTestButton": "Send test WhatsApp",

    // WhatsApp message templates
    "templates.category.whatsapp": "WhatsApp Messages",
    "templates.whatsapp.previewFailed": "Failed to preview WhatsApp message.",
    "templates.whatsapp.saved": "WhatsApp template saved.",
    "templates.whatsapp.saveFailed": "Failed to save WhatsApp template.",
    "templates.whatsapp.resetDone": "WhatsApp template reset.",
    "templates.whatsapp.resetFailed": "Failed to reset WhatsApp template.",
    "templates.whatsapp.phoneInvalid":
      "Enter a phone number in E.164 format, for example +201013530963.",
    "templates.whatsapp.testSent": "Test WhatsApp message submitted.",
    "templates.whatsapp.testFailed": "Test WhatsApp message failed.",
    "templates.whatsapp.empty": "No WhatsApp templates found.",
    "templates.whatsapp.custom": "Custom",
    "templates.whatsapp.default": "Default",
    "templates.whatsapp.preview": "Preview",
    "templates.whatsapp.reset": "Reset",
    "templates.whatsapp.body": "Message Body",
    "templates.whatsapp.previewTitle": "Preview",
    "templates.whatsapp.previewEmpty":
      "Click Preview to render a sample message.",
    "templates.whatsapp.sendTest": "Send Test",

    // Employees, profile, contracts
    ...
    "employees.status.prehire": "Pre-hire",
    "employees.status.suspended": "Suspended",
    "employees.status.terminated": "Terminated",
    "contractDecisions.finalNotification": "Final notification",
    "profile.leaveBalances": "Leave Balances",
    "profile.leaveBalanceYear": "Year",

    // Reference data forms
    "reference.codeMax": "Code must be at most {max} characters",
    "reference.nameMax": "Name must be at most {max} characters",
    "reference.optionalDescription": "Optional description",
    "reference.departments.codePlaceholder": "e.g., ENG",
    "reference.departments.namePlaceholder": "e.g., Engineering",
    "reference.positions.codePlaceholder": "e.g., MGR",
    "reference.positions.namePlaceholder": "e.g., Manager",
    "reference.taskGroups.codePlaceholder": "e.g., PROJ",
    "reference.taskGroups.namePlaceholder": "e.g., Project Tasks",
    "reference.sponsors.codePlaceholder": "e.g., SPONSOR-001",
    "reference.sponsors.namePlaceholder": "Optional sponsor name",
    "reference.rentTypes.codePlaceholder": "e.g., OFFICE",
    "reference.rentTypes.namePlaceholder": "e.g., Office Rent",

    // Payroll & BioTime
    "payroll.status.DRAFT": "Draft",
    "payroll.status.COMPLETED": "Completed",
    "payroll.status.PAID": "Paid",
    "payroll.status.CANCELLED": "Cancelled",
    "payroll.runDetails.payslipsUpdatedDesc":
      "{generated} payslips updated. Total payslips: {total}.",
    "bioTime.manualSyncHint":
      "The BioTime office agent performs synchronization from inside the office network. AWS cannot directly test or sync the private device.",

    // Audit log actions & entities emitted by the backend
    "audit.action.announcement_attachment_downloaded":
      "Announcement Attachment Downloaded",
    "audit.action.announcement_whatsapp_groups_listed":
      "WhatsApp Groups Listed",
    "audit.action.annual_leave_payment_ceo_approved":
      "Annual Leave Settlement Approved (CEO)",
    "audit.action.annual_leave_payment_ceo_rejected":
      "Annual Leave Settlement Rejected (CEO)",
    "audit.action.annual_leave_payment_eligibility_viewed":
      "Annual Leave Settlement Eligibility Viewed",
    "audit.action.annual_leave_payment_exported_pdf":
      "Exported Annual Leave Settlement PDF",
    "audit.action.annual_leave_payment_hr_reviewed":
      "Annual Leave Settlement Reviewed (HR)",
    "audit.action.annual_leave_payment_submitted":
      "Annual Leave Settlement Submitted",
    "audit.action.approve_ceo": "Approved (CEO)",
    "audit.action.approve_delegate": "Approved (Alternative Employee)",
    "audit.action.asset_damage_report_approved_ceo":
      "Damage Report Approved (CEO)",
    "audit.action.asset_damage_report_rejected_ceo":
      "Damage Report Rejected (CEO)",
    "audit.action.asset_damage_reported": "Asset Damage Reported",
    "audit.action.asset_label_printed": "Asset Label Printed",
    "audit.action.asset_return_request_approved_ceo":
      "Return Request Approved (CEO)",
    "audit.action.asset_return_request_approved_hr":
      "Return Request Approved (HR)",
    "audit.action.asset_return_request_approved_manager":
      "Return Request Approved (Manager)",
    "audit.action.asset_return_request_rejected_ceo":
      "Return Request Rejected (CEO)",
    "audit.action.asset_return_request_rejected_hr":
      "Return Request Rejected (HR)",
    "audit.action.asset_return_request_rejected_manager":
      "Return Request Rejected (Manager)",
    "audit.action.asset_return_requested": "Asset Return Requested",
    "audit.action.asset_returned": "Asset Returned",
    "audit.action.attendance.absence_detection_run": "Absence Detection Run",
    "audit.action.attendance.work_location_created": "Work Location Created",
    "audit.action.attendance.work_location_deleted": "Work Location Deleted",
    "audit.action.attendance.work_location_updated": "Work Location Updated",
    "audit.action.biotime.mapping_created": "BioTime Mapping Created",
    "audit.action.biotime.mapping_deleted": "BioTime Mapping Deleted",
    "audit.action.biotime.mapping_updated": "BioTime Mapping Updated",
    "audit.action.complete_hr": "Completed by HR",
    "audit.action.contract_decision_auto_approved":
      "Contract Decision Auto-Approved",
    "audit.action.contract_decision_auto_renewed": "Contract Auto-Renewed",
    "audit.action.contract_decision_manual_resolution_required":
      "Contract Decision Needs Manual Resolution",
    "audit.action.contract_decision_rejected": "Contract Decision Rejected",
    "audit.action.create_adjustment": "Balance Adjustment Created",
    "audit.action.cross_company_manager_assignment_created":
      "Cross-Company Manager Assigned",
    "audit.action.cross_company_manager_assignment_revoked":
      "Cross-Company Manager Assignment Revoked",
    "audit.action.cross_company_manager_assignment_updated":
      "Cross-Company Manager Assignment Updated",
    "audit.action.delegation_rule_created": "Alternative Employee Rule Created",
    "audit.action.delegation_rule_revoked": "Alternative Employee Rule Revoked",
    "audit.action.delegation_rule_updated": "Alternative Employee Rule Updated",
    "audit.action.employee_archive_rejected": "Employee Archive Rejected",
    "audit.action.employee_archive_requested": "Employee Archive Requested",
    "audit.action.employee_archived": "Employee Archived",
    "audit.action.employee_document_deleted": "Employee Document Deleted",
    "audit.action.employee_document_downloaded": "Employee Document Downloaded",
    "audit.action.employee_document_expiry_whatsapp_sent":
      "Document Expiry WhatsApp Sent",
    "audit.action.employee_document_extraction_queued":
      "Document Extraction Queued",
    "audit.action.employee_document_updated": "Employee Document Updated",
    "audit.action.employee_document_uploaded": "Employee Document Uploaded",
    "audit.action.employee_manager_changed": "Employee Manager Changed",
    "audit.action.employee_manager_legacy_synced": "Employee Manager Synced",
    "audit.action.employee_restored": "Employee Restored",
    "audit.action.employee_signature_deleted": "Employee Signature Deleted",
    "audit.action.employee_signature_previewed": "Employee Signature Previewed",
    "audit.action.employee_signature_replaced": "Employee Signature Replaced",
    "audit.action.employee_work_license_expiry_whatsapp_queued":
      "Work License Expiry WhatsApp Queued",
    "audit.action.invite_resent": "Invite Resent",
    "audit.action.job_offer_accepted": "Job Offer Accepted",
    "audit.action.job_offer_accepted_profile_updated":
      "Profile Updated from Accepted Job Offer",
    "audit.action.job_offer_biotime_mapping_missing_notified":
      "Missing BioTime Mapping Notification Sent",
    "audit.action.job_offer_biotime_mapping_present":
      "BioTime Mapping Confirmed",
    "audit.action.job_offer_cancelled": "Job Offer Cancelled",
    "audit.action.job_offer_ceo_copy_sent": "Job Offer Copy Sent to CEO",
    "audit.action.job_offer_created": "Job Offer Created",
    "audit.action.job_offer_cv_downloaded": "Candidate CV Downloaded",
    "audit.action.job_offer_delivery_failed": "Job Offer Delivery Failed",
    "audit.action.job_offer_invitation_sent": "Job Offer Invitation Sent",
    "audit.action.job_offer_pdf_downloaded": "Job Offer PDF Downloaded",
    "audit.action.job_offer_rejected": "Job Offer Rejected",
    "audit.action.job_offer_sent": "Job Offer Sent",
    "audit.action.job_offer_submitted_for_ceo_approval":
      "Job Offer Submitted for CEO Approval",
    "audit.action.job_offer_whatsapp_pdf_sent":
      "Job Offer PDF Sent via WhatsApp",
    "audit.action.leave_delegate_updated": "Leave Alternative Employee Updated",
    "audit.action.leave_type_created": "Leave Type Created",
    "audit.action.leave_type_deactivated": "Leave Type Deactivated",
    "audit.action.leave_type_updated": "Leave Type Updated",
    "audit.action.loan_deducted_in_payroll": "Loan Deducted in Payroll",
    "audit.action.loan_request_exported_pdf": "Exported Loan Request PDF",
    "audit.action.loan_request_submitted": "Loan Request Submitted",
    "audit.action.logout": "Logout",
    "audit.action.manager_stage_fallback_to_hr": "Manager Stage Routed to HR",
    "audit.action.manual_leave_record_deleted": "Manual Leave Record Deleted",
    "audit.action.manual_leave_record_updated": "Manual Leave Record Updated",
    "audit.action.organization_scope_created": "Organization Scope Created",
    "audit.action.organization_scope_updated": "Organization Scope Updated",
    "audit.action.password_changed": "Password Changed",
    "audit.action.payslip_list_viewed": "Payslip List Viewed",
    "audit.action.reject_ceo": "Rejected (CEO)",
    "audit.action.reject_delegate": "Rejected (Alternative Employee)",
    "audit.action.rent_created": "Rent Created",
    "audit.action.rent_deleted": "Rent Deleted",
    "audit.action.rent_exported_pdf": "Exported Rent PDF",
    "audit.action.rent_payment_created": "Rent Payment Recorded",
    "audit.action.rent_type_created": "Rent Type Created",
    "audit.action.rent_type_deleted": "Rent Type Deleted",
    "audit.action.rent_type_updated": "Rent Type Updated",
    "audit.action.rent_updated": "Rent Updated",
    "audit.action.request_obligation_waived": "Request Obligation Waived",
    "audit.action.send_to_ceo": "Sent to CEO",
    "audit.action.settings_updated": "Settings Updated",
    "audit.action.starting_work_acknowledgment_approved":
      "Starting Work Verification Approved",
    "audit.action.starting_work_acknowledgment_pdf_downloaded":
      "Starting Work Verification PDF Downloaded",
    "audit.action.starting_work_acknowledgment_rejected":
      "Starting Work Verification Rejected",
    "audit.action.user_created": "User Created",
    "audit.action.user_organization_access_changed":
      "User Company Access Changed",
    "audit.action.user_password_reset": "User Password Reset",
    "audit.action.user_role_changed": "User Role Changed",
    "audit.action.user_status_changed": "User Status Changed",
    "audit.action.whatsapp_template_reset": "WhatsApp Template Reset",
    "audit.action.whatsapp_template_updated": "WhatsApp Template Updated",
    "audit.entity.AnnualLeavePaymentRequest": "Annual Leave Settlement",
    "audit.entity.AssetDamageReport": "Asset Damage Report",
    "audit.entity.AssetReturnRequest": "Asset Return Request",
    "audit.entity.ContractDecision": "Contract Decision",
    "audit.entity.EmployeeProfile": "Employee Profile",
    "audit.entity.JobOffer": "Job Offer",
    "audit.entity.OrganizationNode": "Organization",
    "audit.entity.Payslip": "Payslip",
    "audit.entity.PrintedLabelJob": "Label Print Job",
    "audit.entity.RequestObligation": "Request Obligation",
    "audit.entity.StartingWorkAcknowledgment": "Starting Work Verification",
    "audit.entity.User": "User",
    "audit.entity.WhatsAppMessageTemplate": "WhatsApp Template",
    "audit.entity.attendance_absence_run": "Absence Detection Run",
    "audit.entity.auth": "Authentication",
    "audit.entity.biotime_employee_map": "BioTime Mapping",
    "audit.entity.cross_company_manager_assignment":
      "Cross-Company Manager Assignment",
    "audit.entity.delegation_rule": "Alternative Employee Rule",
    "audit.entity.employee_deletion_request": "Employee Archive Request",
    "audit.entity.employee_document": "Employee Document",
    "audit.entity.leave_balance_adjustment": "Leave Balance Adjustment",
    "audit.entity.leave_type": "Leave Type",
    "audit.entity.organization_scope": "Organization Scope",
    "audit.entity.rent_payment": "Rent Payment",
    "audit.entity.rent_type": "Rent Type",
    "audit.entity.settings": "Settings",
    "audit.entity.work_location": "Work Location",
    "audit.action.job_offer_ceo_approved": "Job Offer Approved (CEO)",
    "audit.action.job_offer_ceo_rejected": "Job Offer Rejected (CEO)",
    "audit.action.job_offer_changes_requested": "Job Offer Changes Requested",
    "audit.action.job_offer_updated": "Job Offer Updated",
    "audit.action.asset_damage_report_exported_packet":
      "Exported Damage Report Packet",
    "audit.action.asset_damage_report_exported_pdf":
      "Exported Damage Report PDF",
    "audit.action.asset_return_request_exported_packet":
      "Exported Return Request Packet",
    "audit.action.asset_return_request_exported_pdf":
      "Exported Return Request PDF",
    "audit.action.asset_returned_auto_termination":
      "Asset Returned on Termination",
    "attendance.corrections": "Corrections",

    // Contract decision system texts, notification milestones and deliveries
    ...
    "contractDecisions.milestone.contract.expiry": "Contract expiry notice",
    "contractDecisions.milestone.contract.expiry_milestone": "Expiry reminder",
    "contractDecisions.milestone.contract.ceo_pending": "Sent to CEO",
    "contractDecisions.milestone.contract.ceo_reminder": "CEO reminder",
    "contractDecisions.milestone.contract.decision_completed":
      "Decision completed",
    ...
    "contractDecisions.milestone.contract.renewal_settlement_review_required":
      "Renewal settlement review",
    ...
    "contractDecisions.deliveryStatus.failed": "failed",
    "contractDecisions.deliveryStatus.pending": "pending",
    "contractDecisions.deliveryStatus.skipped": "skipped",
    "workflow.note.contractExpiryCreated": "Contract expiry workflow created",
    "workflow.note.autoRenewedNoHrAction":
      "Automatically renewed because HR took no action",
    "layout.contractRatings": "Contract Ratings",
    "contractDecisions.ratingSummary": "Contract rating",
    "contractDecisions.ratingNone": "No contract rating for this cycle yet.",
    "contractDecisions.ratingHrApproved": "HR approved",
    ...
    "contractRatings.loading": "Loading contract rating…",
    "contractRatings.notFound":
      "This contract rating was not found or is not available to you.",
    "contractRatings.forbidden":
      "You do not have access to this contract rating.",
    "contractRatings.notManagerRating":
      "You are not the manager rating this employee.",
    "contractRatings.notEmployeeRating":
      "This self-evaluation belongs to another employee.",
    "contractRatings.staleAction":
      "This rating changed or you can no longer act on it. It has been reloaded.",
    "contractRatings.validationTitle": "The request could not be completed",
    "contractRatings.actionFailed": "The action could not be completed.",
    "contractRatings.resultStatus": "Rating status: {status}",
    "contractRatings.submitted": "Your evaluation was submitted.",
    "contractRatings.submit": "Submit evaluation",
    "contractRatings.resubmit": "Resubmit evaluation",
    "contractRatings.grade": "Grade",
    "contractRatings.score": "Score",
    "contractRatings.remark": "Remark",
    "contractRatings.remarkPlaceholder": "Optional remark",
    "contractRatings.allowedRange": "Allowed range: {min}–{max}",
    "contractRatings.selectGradeFirst": "Select a grade first",
    "contractRatings.gradeRequired": "Select a grade and enter a score.",
    "contractRatings.scoreOutOfRange":
      "Enter a whole number between {min} and {max}.",
    "contractRatings.progress": "{complete} of {total} criteria completed",
    "contractRatings.estimatedAverage": "Preview average: {average} ({grade})",
    "contractRatings.estimateDisclaimer":
      "Estimate only. The official average and overall grade are calculated by the server when you submit.",
    "contractRatings.overallRemark": "Overall remark",
    "contractRatings.recommendationSection": "Recommendation",
    "contractRatings.recommendation": "Recommendation",
    "contractRatings.recommendationRequired": "Select a recommendation.",
    "contractRatings.changeTypes": "Changes",
    "contractRatings.changeTypesRequired": "Select at least one change.",
    "contractRatings.salaryProposal": "Salary proposal",
    "contractRatings.salaryProposalHint":
      "Enter only the components you propose to change; blank components keep their current value. The server calculates the total.",
    "contractRatings.salaryProposalRequired":
      "Enter at least one proposed salary component.",
    "contractRatings.salaryEffectiveDate": "Salary effective date",
    "contractRatings.salaryEffectiveDateHint":
      "Leave blank to use the day after the contract expiry.",
    "contractRatings.proposedJobTitle": "Proposed job title",
    "contractRatings.proposedPosition": "Proposed position",
    "contractRatings.positionsUnavailable":
      "The position list could not be loaded. Please retry.",
    "contractRatings.otherChangeNotes": "Other change details",
    "contractRatings.fieldRequired": "This field is required.",
    "contractRatings.confidentialManager":
    ...
    "contractRatings.yourSelfEvaluation": "Your self-evaluation",
    "contractRatings.manualResolutionNotice":
      "This rating needs manual resolution by HR because the contract changed.",
    "contractRatings.manualResolutionHint":
      "The contract, employee profile or salary changed after the rating started. No further workflow action is possible on this rating.",
    "contractRatings.employee": "Employee",
    "contractRatings.employeeNumber": "Employee number",
    "contractRatings.department": "Department",
    "contractRatings.section": "Section",
    "contractRatings.jobTitle": "Job title",
    "contractRatings.manager": "Manager",
    "contractRatings.contractStart": "Contract start",
    "contractRatings.contractExpiry": "Contract expiry",
    "contractRatings.evaluationPeriod": "Evaluation period",
    "contractRatings.statusLabel": "Status",
    "contractRatings.criterion": "Criterion",
    "contractRatings.averageScore": "Average score",
    "contractRatings.overallGrade": "Overall grade",
    "contractRatings.responseStatus": "Response status",
    "contractRatings.submittedBy": "Submitted by",
    "contractRatings.submittedAt": "Submitted at",
    "contractRatings.filter": "Status",
    "contractRatings.empty": "No contract ratings",
    "contractRatings.emptyDescription": "No ratings match this filter.",
    "contractRatings.restrictedViewTitle": "You are a rater on this evaluation",
    "contractRatings.restrictedViewBody":
      "Because you are this employee's manager or the employee, you only see your own side. Review and approval must be done by someone else.",
    "contractRatings.openOwnPage": "Open my evaluation",
    "contractRatings.remainingDays": "Remaining contract days",
    "contractRatings.employmentStatus": "Employment status",
    "contractRatings.profileArchived": "Profile archived",
    "contractRatings.managerRecommendation": "Manager recommendation",
    "contractRatings.notSubmittedYet": "Not submitted yet.",
    "contractRatings.salarySection": "Salary",
    "contractRatings.currentSalary": "Current salary (live)",
    "contractRatings.salaryBefore": "Salary before the decision",
    "contractRatings.proposedSalary": "Manager-proposed salary",
    "contractRatings.ceoApprovedSalary": "CEO-approved salary",
    "contractRatings.salaryIncrease": "Increase",
    "contractRatings.overrideReason": "Salary override reason",
    "contractRatings.salaryApplied": "Applied to profile",
    "contractRatings.salaryNotApplied": "Not applied",
    "contractRatings.noSalaryProposal": "No salary change proposed.",
    "contractRatings.comparison": "Comparison",
    "contractRatings.comparisonUnavailable":
      "The comparison is available once both evaluations are submitted.",
    "contractRatings.managerColumn": "Manager",
    "contractRatings.employeeColumn": "Employee",
    "contractRatings.difference": "Difference",
    "contractRatings.differenceHint":
      "Differences of {points} points or more are highlighted for attention only.",
    "contractRatings.managerAverage": "Manager average",
    "contractRatings.employeeAverage": "Employee average",
    "contractRatings.managerEvaluation": "Manager evaluation",
    "contractRatings.employeeEvaluation": "Employee self-evaluation",
    "contractRatings.reviewSection": "HR review and CEO decision",
    "contractRatings.hrReviewedBy": "HR reviewer",
    "contractRatings.hrDecidedAt": "HR reviewed at",
    "contractRatings.hrComment": "HR comment",
    "contractRatings.ceoAction": "CEO action",
    "contractRatings.ceoSelectedOption": "Alternative decision",
    "contractRatings.ceoDecidedBy": "Decided by",
    "contractRatings.ceoDecidedAt": "Decided at",
    "contractRatings.ceoComment": "CEO comment",
    "contractRatings.hrApprove": "Approve and send to CEO",
    "contractRatings.hrReturn": "Return for correction",
    "contractRatings.hrApproveTitle": "Approve this rating",
    "contractRatings.hrReturnTitle": "Return for correction",
    "contractRatings.returnTarget": "Return to",
    "contractRatings.returnReason": "Reason",
    "contractRatings.reasonRequired": "A reason is required.",
    "contractRatings.optionalComment": "Comment (optional)",
    "contractRatings.ceoCannotAct":
      "You cannot decide this rating (for example, you submitted the manager evaluation).",
    "contractRatings.ceoAcceptTitle": "Accept the manager's recommendation",
    "contractRatings.ceoDeclineTitle": "Decline this rating",
    "contractRatings.ceoReturnTitle": "Return to HR",
    "contractRatings.ceoAlternativeTitle": "Decline and select an alternative",
    "contractRatings.ceoReturnHint":
      "The rating goes back to HR for another review. This is not a final decision.",
    "contractRatings.acceptHint":
      "The manager's recommendation is approved. No salary change applies.",
    "contractRatings.acceptSalaryHint":
      "The manager's proposed salary is applied to the employee profile immediately.",
    "contractRatings.acceptTerminateHint":
      "Termination is scheduled for the contract expiry date. The employee stays active until then.",
    "contractRatings.alternativeTerminateHint":
      "Termination is scheduled for the contract expiry date; no salary change applies.",
    "contractRatings.alternativeKeepsProposal":
      "Without an override, the manager's proposed salary is applied.",
    "contractRatings.alternativeNoSalary":
      "The manager proposed no salary change. Override to set one.",
    "contractRatings.overrideSalary": "Set a different salary",
    "contractRatings.overrideSalaryHint":
      "Blank components keep the employee's current value. The server calculates the total.",
    "contractRatings.acknowledge": "Record employee notified",
    "contractRatings.acknowledgeTitle": "Record termination notice",
    "contractRatings.acknowledgeBody":
      "Confirm that the employee has been told about the scheduled termination. This is record-keeping only and does not change the termination date.",
    "contractRatings.terminationScheduled":
      "Termination scheduled for {date}. The employee remains active until then.",
    "contractRatings.terminationProcessed":
      "Termination processed at contract end.",
    "contractRatings.employeeNotified": "Employee notified",
    "contractRatings.employeeNotNotified": "Not recorded yet",
    "contractRatings.archiveReason": "Termination reason",
    "contractRatings.archiveReasonEndOfContract": "Contract end / not renewed",
    "contractRatings.lastWorkingDate": "Last working date",
    "contractRatings.processedAt": "Processed at",
    "contractRatings.history": "Workflow history",
    "contractRatings.historyEmpty": "No workflow steps recorded yet.",
    "contractRatings.status.PENDING_RESPONSES": "Awaiting both evaluations",
    "contractRatings.status.WAITING_MANAGER": "Awaiting manager",
    "contractRatings.status.WAITING_EMPLOYEE": "Awaiting employee",
    "contractRatings.status.PENDING_HR": "Pending HR review",
    "contractRatings.status.PENDING_CEO": "Pending CEO decision",
    "contractRatings.status.APPROVED": "Approved",
    "contractRatings.status.REJECTED": "Declined",
    "contractRatings.status.MANUAL_RESOLUTION_REQUIRED":
      "Manual resolution required",
    "contractRatings.gradeLabel.EXCELLENT": "Excellent",
    "contractRatings.gradeLabel.VERY_GOOD": "Very good",
    "contractRatings.gradeLabel.GOOD": "Good",
    "contractRatings.gradeLabel.ACCEPTABLE": "Acceptable",
    "contractRatings.gradeLabel.POOR": "Poor",
    "contractRatings.recommendationLabel.CONTINUE_CONTRACT":
      "Continue the contract",
    "contractRatings.recommendationLabel.CONTINUE_WITH_CHANGES":
      "Continue with changes",
    "contractRatings.recommendationLabel.TERMINATE": "Terminate",
    "contractRatings.changeTypeLabel.SALARY_INCREASE": "Salary increase",
    "contractRatings.changeTypeLabel.JOB_TITLE_CHANGE": "Job title change",
    "contractRatings.changeTypeLabel.POSITION_CHANGE": "Position change",
    "contractRatings.changeTypeLabel.OTHER": "Other",
    "contractRatings.ceoActionLabel.ACCEPT": "Accept",
    "contractRatings.ceoActionLabel.RETURN_TO_HR": "Return to HR",
    "contractRatings.ceoActionLabel.DECLINE": "Decline",
    "contractRatings.ceoActionLabel.DECLINE_WITH_ALTERNATIVE":
      "Decline with alternative",
    "contractRatings.alternative.RENEW": "Renew",
    "contractRatings.alternative.RENEW_WITH_CHANGES": "Renew with changes",
    "contractRatings.alternative.TERMINATE": "Terminate",
    "contractRatings.returnTargetLabel.return-manager": "Manager",
    "contractRatings.returnTargetLabel.return-employee": "Employee",
    "contractRatings.returnTargetLabel.return-both": "Both",
    "contractRatings.responseStatusLabel.SUBMITTED": "Submitted",
    "contractRatings.responseStatusLabel.RETURNED": "Returned for correction",
    "contractRatings.checkingPending":
      "Checking your contract rating status...",
    "contractRatings.requiredSelfRatingTitle":
      "Complete your self-evaluation to continue",
    "contractRatings.requiredSelfRatingDescription":
      "You have an outstanding contract self-evaluation. Submit it to regain access to the rest of the employee portal.",
    "contractRatings.requiredManagerRatingTitle":
      "Complete this employee evaluation to continue",
    "contractRatings.requiredManagerRatingDescription":
      "You have an outstanding contract evaluation for a direct report. Submit it to regain access to the rest of the manager portal.",
    "contractRatings.previewPdf": "Preview PDF",
    "contractRatings.downloadPdf": "Download PDF",
    "contractRatings.pdfFailed": "Could not download the contract rating PDF.",
    "contractRatings.pdfPreviewFailed":
      "Could not open the contract rating PDF preview.",
    "contractRatings.status.PENDING_HR_GATE": "Awaiting HR routing",
    "contractRatings.status.DECIDED": "Decided",
    "contractRatings.ratingMode.UNDECIDED": "Not routed yet",
    "contractRatings.ratingMode.RATE": "Rated",
    "contractRatings.ratingMode.SKIP_TO_CEO": "Sent to CEO without rating",
    "contractRatings.routing": "Routing",
  ...
  ar: {
    ...
    "employee.dashboard.submittedOn": "تاريخ التقديم",
    "employee.dashboard.intro":
      "طلباتك وسجلات عملك وخدماتك اليومية في مكان واحد.",
    "employee.dashboard.selfService": "الخدمات الذاتية للموظف",
    "employee.dashboard.requestsTitle": "ما الطلب الذي تود تقديمه؟",
    "employee.dashboard.requestsHint":
      "قدّم طلبًا جديدًا أو تابع حالة طلباتك السابقة.",
    "employee.dashboard.newRequest": "طلب جديد",
    "employee.dashboard.trackRequests": "متابعة طلباتي",
    "employee.dashboard.leaveHint": "خطّط لإجازتك وأرسل طلبك للاعتماد.",
    "employee.dashboard.loans": "طلبات السلف",
    "employee.dashboard.loanHint": "قدّم طلب سلفة وتابع مراحل اعتماده.",
    "employee.dashboard.servicesTitle": "خدماتك اليومية",
    "employee.dashboard.servicesHint": "اعثر على سجلاتك وأدر يوم عملك.",
    "employee.dashboard.searchServices": "ابحث عن خدمة، مثل قسائم الرواتب",
    "employee.dashboard.attendance": "حضوري",
    "employee.dashboard.attendanceHint": "راجع سجلات الحضور وساعات العمل.",
    "employee.dashboard.balance": "رصيد الإجازات",
    "employee.dashboard.balanceHint":
      "تحقّق من الأيام المتاحة قبل التخطيط لإجازتك القادمة.",
    "employee.dashboard.corrections": "تصحيح الحضور",
    "employee.dashboard.correctionsHint":
      "اطلب تصحيح سجل الحضور وتابع طلباتك السابقة.",
    "employee.dashboard.assets": "عُهدي",
    "employee.dashboard.assetsHint": "استعرض المعدات والعهد المسلّمة إليك.",
    "employee.dashboard.delegated": "الاعتمادات المفوّضة",
    "employee.dashboard.delegatedHint":
      "راجع طلبات الإجازة المفوّضة إليك للاعتماد.",
    "employee.dashboard.noServices": "لا توجد خدمات تطابق بحثك.",
    "employee.dashboard.clearSearch": "عرض جميع الخدمات",
    "employee.dashboard.profileError":
    ...
    "resetPassword.missingToken":
      "رابط إعادة التعيين هذا يفتقد إلى معلومات مطلوبة.",
    ...
    "layout.organizationSetup": "الهيكل التنظيمي",
    ...
    "layout.teamPermissionRequests": "طلبات إذن الفريق",
    "layout.myTeam": "فريقي",
    ...
    "layout.nav.alternateApprovals": "موافقات الموظف البديل",
    "layout.nav.alternatesSetup": "خيار موظف بديل",
    "layout.nav.leaveSettlements": "تسويات الإجازة السنوية",
    "layout.nav.permissionInbox": "صندوق الاستئذانات",
    "layout.nav.myPermissions": "طلبات الإذن الخاصة بي",
    "layout.nav.leaveApprovals": "موافقات الإجازات",
    "layout.nav.biotimeSettings": "إعدادات BioTime",
    "layout.nav.whatsapp": "واتساب",
    "layout.nav.myAttendance": "حضوري",
    "layout.menu.hiring": "التوظيف",
    "layout.menu.payrollAssets": "الرواتب والأصول",
    "layout.menu.communication": "التواصل",
    "layout.nav.requestQueues": "الطلبات",
    ...
    "common.role": "الدور",
    "common.weekday.sunday": "الأحد",
    "common.weekday.monday": "الإثنين",
    "common.weekday.tuesday": "الثلاثاء",
    "common.weekday.wednesday": "الأربعاء",
    "common.weekday.thursday": "الخميس",
    "common.weekday.friday": "الجمعة",
    "common.weekday.saturday": "السبت",
    ...
    "status.expiringSoon": "تنتهي قريباً",
    "status.valid": "ساري",
    ...
    "error.unauthorized.redirecting":
      "جارٍ إعادة توجيهك إلى الصفحة الرئيسية ({seconds})…",
    ...
    "employee.dashboard.permissionTitle": "إذن خروج",
    "employee.dashboard.permissionDesc":
    ...
    "permissionRequests.form.toTime": "وقت النهاية",
    "permissionRequests.form.exitType": "نوع الخروج",
    "permissionRequests.form.reason": "السبب",
    ...
    "permissionRequests.list.all": "كل الحالات",
    "permissionRequests.list.reference": "الرقم المرجعي",
    "permissionRequests.list.employee": "الموظف",
    "permissionRequests.list.date": "التاريخ",
    "permissionRequests.list.time": "الوقت",
    "permissionRequests.list.type": "النوع",
    "permissionRequests.list.status": "الحالة",
    "permissionRequests.list.empty": "لا توجد أذونات خروج.",
    "permissionRequests.detail.downloadPdf": "تنزيل PDF",
    "permissionRequests.detail.employee": "الموظف",
    "permissionRequests.detail.date": "التاريخ",
    "permissionRequests.detail.time": "الوقت",
    "permissionRequests.detail.duration": "{minutes} دقيقة",
    "permissionRequests.detail.exitType": "نوع الخروج",
    "permissionRequests.detail.reason": "السبب",
    "permissionRequests.detail.directManager": "المدير المباشر",
    "permissionRequests.detail.decisionComment": "تعليق قرار اختياري",
    "permissionRequests.detail.approve": "اعتماد",
    "permissionRequests.detail.reject": "رفض",
    "permissionRequests.detail.cancel": "إلغاء الطلب",
    "permissionRequests.detail.cancelTitle": "هل تريد إلغاء هذا الطلب؟",
    "permissionRequests.detail.history": "سجل سير العمل",
    "permissionRequests.detail.system": "النظام",
    "permissionRequests.detail.none": "غير محدد",
    "permissionRequests.detail.trail": "مسار الاعتماد",
    "permissionRequests.detail.submitted": "تم الإرسال",
    "permissionRequests.detail.managerStage": "اعتماد المدير المباشر",
    "permissionRequests.detail.hrStage": "اعتماد الموارد البشرية",
    "permissionRequests.detail.approver": "المعتمد: {name}",
    "permissionRequests.detail.pending": "قيد الانتظار",
    "permissionRequests.detail.completed": "مكتمل",
    "permissionRequests.detail.skipped": "تم التخطي",
    "permissionRequests.detail.notRequired": "غير مطلوب لهذا الموظف",
    "permissionRequests.detail.cancelledStage": "ملغي",
    "permissionRequests.detail.approvedDecision": "معتمد",
    "permissionRequests.detail.rejectedDecision": "مرفوض",
    "permissionRequests.history.submit": "تم الإرسال",
    "permissionRequests.history.advance": "تم التقدم للمرحلة التالية",
    "permissionRequests.history.approve": "تم الاعتماد",
    "permissionRequests.history.reject": "تم الرفض",
    "permissionRequests.history.cancel": "تم الإلغاء",
    "permissionRequests.status.pendingManager": "بانتظار المدير المباشر",
    "permissionRequests.status.pendingHr": "بانتظار الموارد البشرية",
    "permissionRequests.status.approved": "معتمد",
    "permissionRequests.status.rejected": "مرفوض",
    "permissionRequests.status.cancelled": "ملغي",
    "permissionRequests.error.load": "تعذر تحميل أذونات الخروج.",
    "permissionRequests.error.submit": "تعذر إرسال الطلب.",
    "permissionRequests.error.action": "تعذر تحديث الطلب.",
    "permissionRequests.error.pdf": "تعذر تنزيل ملف PDF.",
    "permissionRequests.error.unauthorized":
      "انتهت جلستك. يرجى تسجيل الدخول مجدداً.",
    "permissionRequests.error.forbidden": "لا تملك صلاحية تنفيذ هذا الإجراء.",
    "permissionRequests.error.notFound":
      "لم يتم العثور على طلب الإذن أو لم يعد مرئياً.",
    "permissionRequests.error.network":
      "حدث خطأ في الشبكة. يرجى المحاولة مرة أخرى.",
    "permissionRequests.error.retry": "إعادة المحاولة",
    "permissionRequests.success.submitted": "تم إرسال طلب الإذن.",
    "permissionRequests.success.updated": "تم تحديث طلب الإذن.",
    "permissionRequests.success.cancelled": "تم إلغاء طلب الإذن.",
    ...
    "attendancePolicy.grace.consumed": "استُخدم وقت السماح",
    ...
    "attendancePolicy.graceReason.monthlyGrace": "ضمن وقت السماح",
    "attendancePolicy.graceReason.outsideGrace": "متأخر: انتهى وقت السماح",
    "attendancePolicy.graceReason.postGraceTolerance":
      "في الموعد ضمن وقت السماح الإضافي بعد إيقاف وقت السماح الشهري",
    "attendancePolicy.graceReason.postGraceLate":
      "متأخر: أُوقف وقت السماح لبقية هذا الشهر",
    ...
    // Attendance policy settings
    "admin.settings.secAttendancePolicy": "سياسة التأخير والاستئذان",
    "admin.settings.lblGraceWindow": "وقت السماح بعد بداية الدوام (بالدقائق)",
    "admin.settings.helpGraceWindow":
      "الدقائق بعد بداية وقت الدوام التي يُسمح فيها بالحضور دون تسجيل تأخير، حتى تُسجّل 3 مخالفات تأخير خلال الشهر (0–240).",
    "admin.settings.lblDefaultShiftEnd": "نهاية وقت العمل",
    "admin.settings.helpDefaultShiftEnd":
      "وقت انتهاء العمل للموظفين الذين ليس لديهم وقت دوام محدد لهم.",
    "admin.settings.lblPostGraceTolerance":
    ...
    "admin.settings.lblDuringShiftMax":
      "أقصى مدة للاستئذان أثناء وقت العمل (بالدقائق)",
    "admin.settings.helpDuringShiftMax":
      "أطول مدة يمكن طلبها للاستئذان أثناء وقت العمل (1–1440).",
    "admin.settings.lblAdvanceLimit": "أقصى مدة لتقديم الطلب مسبقًا (بالأيام)",
    "admin.settings.helpAdvanceLimit":
      "عدد الأيام التي يمكن تقديم طلب الاستئذان خلالها مسبقًا، سواء للتأخير أو أثناء وقت العمل (0–365).",
    ...
    "hr.attendancePolicy.subtitle":
      "أوقات السماح والاستئذان المعتمدة لاحتساب التأخير.",
    "hr.attendancePolicy.globalNotice":
    ...
    "hr.dashboard.welcome": "مرحباً {name}",
    "hr.dashboard.todaySummary": "ملخص الموارد البشرية اليوم — {organization}",
    "hr.dashboard.todaySummaryNoOrg": "ملخص الموارد البشرية اليوم",
    "header.today": "اليوم",
    ...
    "hr.dashboard.workforceStatus": "حالة القوى العاملة",
    "hr.dashboard.workforceStatusDesc": "أين الموظفون اليوم",
    "hr.dashboard.status.currentlyEmployed": "على رأس العمل",
    "hr.dashboard.status.onLeaveOutside": "في إجازة – خارج المملكة",
    "hr.dashboard.status.onLeaveInside": "في إجازة – داخل المملكة",
    "hr.dashboard.activeInactive": "{active} نشط · {inactive} غير نشط",
    "hr.dashboard.expiringDocsTitle": "وثائق قاربت على الانتهاء",
    "hr.dashboard.expiringDocsDesc": "{count} موظف · خلال {days} يومًا القادمة",
    "hr.dashboard.docGroup.national_id": "الهوية الوطنية",
    "hr.dashboard.docGroup.iqama": "الإقامة",
    "hr.dashboard.docGroup.passport": "جواز السفر",
    "hr.dashboard.docGroup.work_license": "رخصة العمل",
    "hr.dashboard.docGroup.contract": "العقد",
    ...
    "hr.dashboard.employeesTotal": "موظف",
    "hr.dashboard.nationality": "الموظفون حسب الجنسية",
    "hr.dashboard.nationalityDesc": "الموظفون الحاليون، باستثناء المؤرشفين",
    "hr.dashboard.otherNationalities": "جنسيات أخرى ({count})",
    "hr.dashboard.nationalityUnknown": "غير محددة",
    "hr.dashboard.saudizationCaption": "نسبة السعودة بين الموظفين النشطين",
    "hr.dashboard.otherStatuses": "حالات أخرى",
    ...
    "leave.hrCancelTitle": "إلغاء طلب الإجازة هذا؟",
    "leave.hrCancelDesc": "سيتم إشعار الموظف. اذكر سبب الإلغاء.",
    "leave.hrCancelReasonPlaceholder": "لماذا يتم إلغاء هذا الطلب؟",
    "leave.hrCancelReasonRequired": "أدخل سبب الإلغاء.",
    "leave.hrCancelSuccess": "تم إلغاء طلب الإجازة",
    "leave.hrCancelFail": "تعذر إلغاء طلب الإجازة",
    "leave.annual": "سنوية",
    "leave.sick": "مرضية",
    ...
    "leave.requestDetailsTitle": "طلب الإجازة رقم {id}",
    "leave.employeeDetailsSubtitle":
    ...
    "attendancePreview.overview": "نظرة عامة",
    "attendancePreview.filters.title": "عوامل التصفية",
    "attendancePreview.resultsCount": "{count} سجل",
    "attendancePreview.status.present": "حاضر",
    "attendancePreview.status.absent": "غائب",
    "attendancePreview.status.excused": "غياب بعذر",
    "attendancePreview.status.lateExcused": "تأخير بعذر",
    "attendancePreview.approvedLeaveReference": "إجازة معتمدة",
    ...
    "attendancePreview.columns.lateBy": "مدة التأخير",
    "attendancePreview.columns.override": "التعديل",
    "attendancePreview.overridden": "معدّل",
    "attendancePreview.notOverridden": "أصلي",
    "attendancePreview.lateArrivalTag": "حضور متأخر",
    "attendancePreview.summary.attendanceRate": "نسبة الحضور",
    "attendancePreview.export.button": "تصدير",
    "attendancePreview.export.empty":
      "لا توجد سجلات للتصدير وفق عوامل التصفية الحالية.",
    "attendancePreview.export.failed": "تعذّر تصدير سجلات الحضور.",
    "attendancePreview.export.capped":
      "اقتصر التصدير على أول {max} صف. ضيّق النطاق الزمني للحصول على الباقي.",
    ...
    "admin.settings.secAttendance": "الحضور",
    "admin.settings.lblGeofenceEnabled": "طلب موقع GPS عند تسجيل الحضور",
    "admin.settings.helpGeofenceEnabled":
      "عند التفعيل، يجب أن يكون الموظف داخل موقع عمل معتمد لتسجيل الحضور أو الانصراف من تطبيق الجوال.",
    "admin.settings.lblWorkDayStart": "وقت بدء يوم العمل",
    "admin.settings.helpWorkDayStart":
      "أي تسجيل حضور بعد هذا الوقت مضافاً إليه فترة السماح يُسجَّل كتأخير.",
    "admin.settings.lblLateGraceMinutes": "فترة السماح للتأخير (بالدقائق)",
    "admin.settings.helpLateGraceMinutes":
      "عدد الدقائق بعد وقت البدء قبل أن يُحتسب الحضور تأخيراً (0–240).",
    ...
    // Admin - Work Locations (geofenced attendance)
    "workLocations.title": "مواقع العمل",
    "workLocations.subtitle":
      "المواقع المعتمدة التي يمكن للموظفين تسجيل الحضور منها عبر الجوال.",
    "workLocations.addButton": "إضافة موقع عمل",
    "workLocations.loading": "جاري تحميل مواقع العمل…",
    "workLocations.loadFailed": "تعذر تحميل مواقع العمل.",
    "workLocations.loadFailedTitle": "تعذر تحميل مواقع العمل",
    "workLocations.emptyTitle": "لا توجد مواقع عمل بعد",
    "workLocations.emptyDescription":
      "أضف موقعاً لتحديد أين يُسمح بتسجيل الحضور عبر الجوال لهذه الشركة.",
    "workLocations.createTitle": "إضافة موقع عمل",
    "workLocations.editTitle": "تعديل موقع العمل",
    "workLocations.createSuccess": "تم إنشاء موقع العمل.",
    "workLocations.createFailed": "تعذر إنشاء موقع العمل.",
    "workLocations.updateSuccess": "تم تحديث موقع العمل.",
    "workLocations.updateFailed": "تعذر تحديث موقع العمل.",
    "workLocations.deleteSuccess": "تمت إزالة موقع العمل.",
    "workLocations.deleteFailed": "تعذرت إزالة موقع العمل.",
    "workLocations.deleteConfirmTitle": "إزالة موقع العمل هذا؟",
    "workLocations.deleteConfirmDescription":
      "لن يقبل {name} تسجيل الحضور عبر الجوال بعد الآن. يمكن إنشاؤه مرة أخرى لاحقاً.",
    "workLocations.editAria": "تعديل {name}",
    "workLocations.deleteAria": "إزالة {name}",
    "workLocations.column.name": "الاسم",
    "workLocations.column.latitude": "خط العرض",
    "workLocations.column.longitude": "خط الطول",
    "workLocations.column.radius": "نطاق التغطية",
    "workLocations.column.company": "الشركة",
    "workLocations.field.name": "اسم الموقع",
    "workLocations.field.latitude": "خط العرض",
    "workLocations.field.longitude": "خط الطول",
    "workLocations.field.radius": "نطاق التغطية",
    "workLocations.rule.nameRequired": "الرجاء إدخال اسم الموقع",
    "workLocations.rule.nameMax": "يجب ألا يتجاوز الاسم 120 حرفاً",
    "workLocations.rule.latitudeRequired": "الرجاء إدخال خط العرض",
    "workLocations.rule.longitudeRequired": "الرجاء إدخال خط الطول",
    "workLocations.rule.radiusRequired": "الرجاء إدخال النطاق بالأمتار",
    "workLocations.placeholder.name": "مثال: المكتب الرئيسي بالرياض",
    "workLocations.placeholder.paste": "الصق الإحداثيات ثم اضغط Enter",
    "workLocations.pickerHint":
      "التقط إحداثيات الموقع، أو الصق خط العرض وخط الطول.",
    "workLocations.useCurrentLocation": "استخدام موقعي الحالي",
    "workLocations.geolocationUnsupported": "هذا المتصفح لا يدعم تحديد الموقع.",
    "workLocations.geolocationCaptured": "تم التقاط الإحداثيات.",
    "workLocations.geolocationFailed":
      "تعذرت قراءة موقعك. اسمح بالوصول إلى الموقع أو أدخل الإحداثيات يدوياً.",
    "workLocations.pasteInvalid": "تعذرت قراءة خط العرض وخط الطول من هذا النص.",
    "workLocations.pasteApplied": "تم تطبيق الإحداثيات.",
    "workLocations.pasteAria": "لصق خط العرض وخط الطول",
    "workLocations.metresUnit": "م",
    "workLocations.metresValue": "{value} م",
    "workLocations.companyScopeNote":
      "يتم حفظ الموقع في الشركة المحددة حالياً في الأعلى.",
    "workLocations.headOfficeNotice": "بدّل إلى شركة لإدارة مواقع عملها.",
    "workLocations.map.placeholder":
      "أدخل خط العرض وخط الطول، أو الصق الإحداثيات، أو استخدم موقعك الحالي لعرض الخريطة.",
    "workLocations.map.ariaLabel":
      "خريطة موقع العمل. انقر على الخريطة أو اسحب المؤشر لتحديد مركز الموقع.",
    "workLocations.map.markerAlt": "مركز موقع العمل",
    "workLocations.map.privacyHint":
      "تُستخدم الخريطة لتحديد مركز موقع العمل فقط. لا يُحفظ سوى الإحداثيات النهائية ونطاق التغطية المختار — دون حفظ صورة الخريطة أو العنوان أو بيانات مواقع الموظفين.",
    ...
    "reference.departments.entity": "قسم",
    ...
    "reference.positions.entity": "منصب",
    "reference.positions.create": "إنشاء منصب",
    "reference.taskGroups.title": "مجموعات المهام",
    "reference.taskGroups.entity": "مجموعة مهام",
    "reference.sponsors.title": "الكفلاء",
    "reference.sponsors.entity": "كفيل",
    "reference.noItemsFound": "لا توجد {entity}.",
    "reference.itemsCount": "{count} سجل",
    "reference.setup.subtitle":
      "إدارة الأقسام والمناصب ومجموعات المهام والكفلاء المستخدمة في سجلات الموظفين.",
    ...
    "hr.employees.balances.totalBalance": "إجمالي الرصيد",
    "hr.employees.balances.availableAnnualYearDays":
      "الأيام المتاحة من الإجازة السنوية",
    "hr.employees.balances.accruedThisYear": "المستحق لهذه السنة",
    "hr.employees.balances.used": "المستخدم",
    "hr.employees.balances.pending": "قيد الانتظار",
    "hr.employees.balances.availableToRequest": "المتاح للطلب",
    "hr.employees.balances.remaining": "المتبقي",
    "hr.employees.balances.adjustments": "التعديلات",
    ...
    "manager.requests.loansTab": "السلف",
    "manager.requests.permissionsTab": "الأذونات",
    ...
    // Pending Inbox
    "layout.pendingInbox": "صندوق الطلبات",
    "pendingInbox.title": "الطلبات المعلقة",
    "pendingInbox.subtitle": "الطلبات التي تنتظر إجراءك",
    "pendingInbox.needsAttention": "تحتاج إلى انتباهك",
    "pendingInbox.allClear": "لا توجد طلبات معلقة",
    "pendingInbox.searchPlaceholder": "البحث بالاسم...",
    "pendingInbox.filterAll": "الكل",
    "pendingInbox.noMatches": "لا توجد طلبات معلقة تطابق هذه التصفية",
    "pendingInbox.waitingLong": "بانتظار الإجراء منذ أكثر من 3 أيام",
    ...
    "pendingInbox.requestType.CONTRACT_DECISION": "قرار العقد",
    "pendingInbox.requestType.CONTRACT_RATING": "تقييم العقد",
    "pendingInbox.requestType.ANNUAL_LEAVE_PAYMENT": "تسوية الإجازة السنوية",
    "layout.contractDecisions": "قرارات العقود",
    "contractDecisions.title": "قرارات العقود",
    "contractDecisions.subtitle": "إدارة العقود التي تقترب من تاريخ الانتهاء.",
    "contractDecisions.detailTitle": "قرار العقد",
    "contractDecisions.employee": "الموظف",
    "contractDecisions.employeeId": "رقم الموظف",
    "contractDecisions.expiry": "انتهاء العقد",
    "contractDecisions.originalExpiry": "الانتهاء الأصلي",
    "contractDecisions.proposedExpiry": "الانتهاء المقترح",
    "contractDecisions.status": "الحالة",
    "contractDecisions.submitted": "تاريخ الإرسال",
    "contractDecisions.decision": "القرار",
    "contractDecisions.ceoDeadline": "الموعد النهائي للرئيس التنفيذي",
    "contractDecisions.hrComment": "ملاحظات الموارد البشرية",
    "contractDecisions.failure": "سبب التعذر",
    "contractDecisions.takeAction": "اتخاذ إجراء",
    "contractDecisions.hrModalTitle": "إرسال قرار الموارد البشرية للعقد",
    "contractDecisions.ceoModalTitle": "قرار الرئيس التنفيذي",
    "contractDecisions.renew": "تجديد",
    "contractDecisions.renewChanges": "تجديد مع تغييرات",
    "contractDecisions.terminate": "إنهاء",
    "contractDecisions.newStart": "تاريخ العقد الجديد",
    "contractDecisions.newExpiry": "تاريخ انتهاء العقد الجديد",
    "contractDecisions.termsHint":
      "للتجديد مع تغييرات، أدخل فقط حقول الراتب أو البدلات التي تريد تعديلها.",
    "contractDecisions.commentPlaceholder": "ملاحظة اختيارية",
    "contractDecisions.submit": "إرسال إلى الرئيس التنفيذي",
    "contractDecisions.approve": "اعتماد",
    "contractDecisions.reject": "رفض",
    "contractDecisions.submitSuccess": "تم إرسال القرار إلى الرئيس التنفيذي.",
    "contractDecisions.approveSuccess": "تم اعتماد قرار العقد.",
    "contractDecisions.rejectSuccess": "تم رفض قرار العقد.",
    "contractDecisions.autoRenewed":
      "تم تجديد العقد تلقائياً لعدم اتخاذ الموارد البشرية إجراءً.",
    "contractDecisions.notifications": "حالة الإشعارات",
    "contractDecisions.filter": "عرض",
    "contractDecisions.pendingHr": "بانتظار إجراء الموارد البشرية",
    "contractDecisions.pendingCeo": "بانتظار اعتماد الرئيس التنفيذي",
    "contractDecisions.approved": "معتمد",
    ...
    "executive.annualLeave": "مستحقات الإجازة السنوية",
    "executive.partial":
      "تعذر تحميل بعض الأعداد. يشمل الإجمالي القوائم المتاحة فقط.",
    "executive.unavailable":
      "العدد غير متاح. افتح القائمة أو حدّث الصفحة للمحاولة مجددًا.",
    "executive.notificationsFailed": "تعذر تحميل الإشعارات.",
    "executive.noUnread": "لا توجد إشعارات غير مقروءة",
    ...
    "notifications.group.lastWeek": "آخر 7 أيام",
    "notifications.group.older": "أقدم",
    ...
    "layout.startingWorkAcknowledgments": "التحقق من حضور BioTime",
    ...
    "jobOffers.action.pdf": "PDF",
    "jobOffers.action.previewPdf": "معاينة PDF",
    ...
    "jobOffers.form.notEditable":
      "يمكن تعديل المسودات والعروض التي أعادها الرئيس التنفيذي للتعديل فقط.",
    "jobOffers.form.contactHint":
    ...
    "jobOffers.reference.emptyTitle":
      "البيانات المرجعية للموارد البشرية غير مكتملة",
    "jobOffers.reference.emptyBoth":
    ...
    "jobOffers.detail.section.applicant": "بيانات المتقدم",
    ...
    "jobOffers.pdf.previewFailed": "تعذر فتح معاينة ملف عرض العمل.",
    ...
    // بوابة موافقة الرئيس التنفيذي — لا يصل العرض للمرشح إلا بعد الموافقة
    "jobOffers.approval.status.all": "كل الموافقات",
    "jobOffers.approval.status.draft": "لم يُرسل بعد",
    "jobOffers.approval.status.pending_ceo": "بانتظار الرئيس التنفيذي",
    "jobOffers.approval.status.approved": "معتمد من الرئيس التنفيذي",
    "jobOffers.approval.status.changes_requested": "طُلبت تعديلات",
    "jobOffers.approval.status.rejected": "مرفوض من الرئيس التنفيذي",
    "jobOffers.approval.awaitingDecision": "بانتظار قرار الرئيس التنفيذي.",
    "jobOffers.approval.notSubmitted":
      "لم يُرسل هذا العرض إلى الرئيس التنفيذي بعد.",
    "jobOffers.approval.approvedBy": "اعتمده {name}",
    "jobOffers.approval.changesRequestedBy": "طلب التعديلات {name}",
    "jobOffers.approval.rejectedBy": "رفضه {name}",
    "jobOffers.approval.changesRequestedTitle": "طلب الرئيس التنفيذي تعديلات",
    "jobOffers.approval.reason": "السبب",
    "jobOffers.approval.reasonRequired": "اكتب سببًا قبل المتابعة.",
    "jobOffers.approval.recommendation": "توصية للموارد البشرية",
    "jobOffers.approval.recommendationHint":
      "إرشادات اختيارية تظهر للموارد البشرية مع القرار.",
    "jobOffers.approval.sendBlocked":
      "لا يمكن إرسال العرض إلى المرشح إلا بعد اعتماد الرئيس التنفيذي له.",
    "jobOffers.approval.requestChanges": "طلب تعديلات",
    "jobOffers.approval.requestChangesTitle": "إعادة العرض إلى الموارد البشرية",
    "jobOffers.approval.rejectTitle": "رفض عرض العمل",
    "jobOffers.approval.approveSuccess": "تم اعتماد عرض العمل.",
    "jobOffers.approval.approveFailed": "تعذر اعتماد عرض العمل.",
    "jobOffers.approval.rejectSuccess": "تم رفض عرض العمل.",
    "jobOffers.approval.rejectFailed": "تعذر رفض عرض العمل.",
    "jobOffers.approval.requestChangesSuccess":
      "أُعيد عرض العمل إلى الموارد البشرية.",
    "jobOffers.approval.requestChangesFailed":
      "تعذر إعادة عرض العمل إلى الموارد البشرية.",
    "jobOffers.col.approvalStatus": "اعتماد الرئيس التنفيذي",
    "jobOffers.col.reference": "الرقم المرجعي",
    "jobOffers.col.submittedAt": "تاريخ الإرسال",
    "jobOffers.filterApprovalStatus": "حالة اعتماد الرئيس التنفيذي",
    "jobOffers.action.downloadCv": "تنزيل السيرة الذاتية",
    "jobOffers.action.previewCv": "معاينة السيرة الذاتية",
    "jobOffers.action.resubmitToCeo": "إعادة الإرسال للرئيس التنفيذي",
    "jobOffers.action.review": "مراجعة",
    "jobOffers.form.section.cv": "السيرة الذاتية للمرشح",
    "jobOffers.form.submitToCeo": "إرسال إلى الرئيس التنفيذي",
    "jobOffers.form.cvDropzone": "أفلت السيرة الذاتية هنا، أو انقر لاختيار ملف",
    "jobOffers.form.cvHint":
      "PDF أو DOC أو DOCX أو JPG أو PNG. حتى 5 ميجابايت.",
    "jobOffers.form.cvTooLarge":
      "يجب ألا يتجاوز حجم السيرة الذاتية 5 ميجابايت.",
    "jobOffers.form.cvWrongType":
      "يجب أن تكون السيرة الذاتية بصيغة PDF أو DOC أو DOCX أو JPG أو PNG.",
    "jobOffers.form.cvRequired": "أرفق السيرة الذاتية للمرشح قبل حفظ العرض.",
    "jobOffers.form.cvRequiredForSubmit":
      "أرفق السيرة الذاتية قبل الإرسال إلى الرئيس التنفيذي.",
    "jobOffers.form.cvAlreadyAttached":
      "السيرة الذاتية مرفقة بالفعل. ارفع ملفًا آخر فقط لاستبدالها.",
    "jobOffers.field.dateOfBirth": "تاريخ الميلاد",
    "jobOffers.field.company": "الشركة",
    "jobOffers.submit.confirmTitle": "إرسال هذا العرض إلى الرئيس التنفيذي؟",
    "jobOffers.submit.confirmBody":
      "سيتم إشعار الرئيس التنفيذي ولن يمكن تعديل العرض حتى يرد.",
    "jobOffers.submit.success": "أُرسل عرض العمل لاعتماد الرئيس التنفيذي.",
    "jobOffers.submit.failed": "تعذر إرسال عرض العمل.",
    "jobOffers.cv.downloaded": "تم تنزيل السيرة الذاتية.",
    "jobOffers.cv.failed": "تعذر تنزيل السيرة الذاتية.",
    "jobOffers.cv.previewUnavailable":
      "تعذّرت معاينة هذه السيرة الذاتية في المتصفح، لذا تم تنزيلها بدلاً من ذلك.",
    "jobOffers.detail.section.ceoReview": "مراجعة الرئيس التنفيذي",
    ...
    "jobOffers.workflow.action.reject": "تم الرفض",
    "jobOffers.workflow.action.cancel": "تم الإلغاء",
    "jobOffers.workflow.action.advance": "انتقل إلى المرحلة التالية",
    "jobOffers.workflow.action.reassign": "أُعيد الإسناد",
    "jobOffers.workflow.action.override": "تم التجاوز",
    "jobOffers.ceo.title": "عروض العمل",
    "jobOffers.ceo.subtitle": "اعتمد العروض قبل وصولها إلى المرشح.",
    "jobOffers.ceo.emptyTitle": "لا يوجد ما يتطلب قرارًا",
    "jobOffers.ceo.emptyDescription": "لا توجد عروض عمل بهذه الحالة.",
    "jobOffers.ceo.backToInbox": "العودة إلى عروض العمل",
    "jobOffers.ceo.decisionTitle": "قرارك",
    "jobOffers.ceo.decisionHint":
      "الاعتماد يتيح للموارد البشرية إرسال العرض إلى المرشح. الإعادة أو الرفض يتطلب سببًا.",
    "jobOffers.ceo.noActionAvailable": "هذا العرض لا ينتظر قرارك.",
    "jobOffers.ceo.section.candidate": "المرشح",
    "jobOffers.ceo.section.commercialTerms": "الشروط التجارية",
    "jobOffers.ceo.editTerms": "تعديل الشروط التجارية",
    "jobOffers.ceo.editTermsHint":
      "يمكنك تعديل الحزمة والمزايا وشروط العقد والتواريخ والوظيفة والإدارة والموقع. بيانات المرشح والسيرة الذاتية تبقى للموارد البشرية.",
    "jobOffers.ceo.saveTerms": "حفظ الشروط",
    "jobOffers.ceo.termsSaved": "تم تحديث الشروط التجارية.",
    ...
    // إقرارات مباشرة العمل (تحقق الموارد البشرية من BioTime)
    "startingWork.title": "التحقق من حضور BioTime",
    "startingWork.subtitle":
      "تحقق من أول حضور للموظف في BioTime قبل احتسابه كوقت عمل.",
    "startingWork.countTag": "{count} سجل",
    "startingWork.filterStatus": "الحالة",
    "startingWork.status.pending_hr": "بانتظار تحقق الموارد البشرية",
    "startingWork.status.approved": "معتمد",
    "startingWork.status.rejected": "مرفوض",
    "startingWork.col.employee": "الموظف",
    "startingWork.col.employeeId": "رقم الموظف",
    "startingWork.col.firstBiotimeDate": "تاريخ أول حضور BioTime",
    "startingWork.col.status": "الحالة",
    "startingWork.col.affectedAttendance": "سجلات الحضور المتأثرة",
    "startingWork.col.generatedAt": "تاريخ الإنشاء",
    "startingWork.col.actions": "الإجراءات",
    "startingWork.pendingRowNote":
      "يتم حجب الحضور عن الرواتب حتى موافقة الموارد البشرية.",
    "startingWork.pendingExplanation":
      "لن يُحتسب حضور هذا الموظف في BioTime كوقت عمل للرواتب حتى توافق عليه الموارد البشرية.",
    "startingWork.rejectedExplanation":
      "تُعلَّم سجلات حضور BioTime المتأثرة كغياب حتى توافق الموارد البشرية على تحقق مُصحَّح.",
    "startingWork.approvalAfterRejectionExplanation":
      "تعيد الموافقة سجلات الحضور المؤهلة في النظام إلى حالة حضور، مع الحفاظ على تصحيحات الموارد البشرية.",
    "startingWork.action.view": "عرض",
    "startingWork.action.refresh": "تحديث",
    "startingWork.action.back": "العودة إلى التحقق من حضور BioTime",
    "startingWork.action.download": "تنزيل الإقرار",
    "startingWork.action.approve": "اعتماد التحقق من BioTime",
    "startingWork.action.reject": "رفض التحقق",
    "startingWork.loadFailed": "تعذر تحميل عمليات التحقق من حضور BioTime.",
    "startingWork.detail.loadFailed": "تعذر تحميل عملية التحقق هذه.",
    "startingWork.detail.notFound": "لم يتم العثور على عملية التحقق هذه.",
    "startingWork.empty.title": "لا توجد عمليات تحقق حتى الآن",
    "startingWork.empty.description":
      "تظهر الإقرارات هنا بعد تسجيل الموظف أول حضور في BioTime.",
    "startingWork.empty.filteredTitle":
      "لا توجد عمليات تحقق مطابقة لهذا الفلتر",
    "startingWork.empty.filteredDescription": "جرّب حالة أخرى.",
    "startingWork.section.record": "سجل التحقق",
    "startingWork.section.employee": "الموظف",
    "startingWork.section.decision": "قرار الموارد البشرية",
    "startingWork.section.history": "سجل سير العمل",
    "startingWork.field.employee": "الموظف",
    "startingWork.field.employeeId": "رقم الموظف",
    "startingWork.field.company": "الشركة",
    "startingWork.field.firstBiotimeDate": "تاريخ أول حضور في BioTime",
    "startingWork.field.referenceNumber": "الرقم المرجعي",
    "startingWork.field.affectedAttendance": "سجلات الحضور المتأثرة",
    "startingWork.field.generatedAt": "تاريخ الإنشاء",
    "startingWork.field.status": "الحالة",
    "startingWork.field.approvedBy": "اعتمدها",
    "startingWork.field.approvedAt": "تاريخ الاعتماد",
    "startingWork.field.rejectedBy": "رفضها",
    "startingWork.field.rejectedAt": "تاريخ الرفض",
    "startingWork.field.rejectionReason": "سبب الرفض",
    "startingWork.decision.none": "لم يُسجَّل أي قرار من الموارد البشرية بعد.",
    "startingWork.approve.confirmTitle": "اعتماد هذا التحقق من BioTime؟",
    "startingWork.approve.success": "تم اعتماد التحقق من BioTime.",
    "startingWork.approve.failed": "تعذر اعتماد التحقق من BioTime.",
    "startingWork.reject.reason": "سبب الرفض",
    "startingWork.reject.reasonPlaceholder": "تعذر التحقق من حضور BioTime.",
    "startingWork.reject.reasonRequired": "سبب الرفض مطلوب.",
    "startingWork.reject.success": "تم رفض التحقق من BioTime.",
    "startingWork.reject.failed": "تعذر رفض التحقق من BioTime.",
    "startingWork.pdf.success": "تم تنزيل الإقرار.",
    "startingWork.pdf.failed": "تعذر تنزيل الإقرار.",
    "startingWork.pdf.approvedNote":
      "يسجّل ملف الإقرار المعتمد اسم موظف الموارد البشرية الذي اعتمده وتاريخ الاعتماد.",
    "startingWork.workflow.empty": "لا يوجد سجل لسير العمل بعد.",
    "startingWork.workflow.currentStage": "المرحلة الحالية",
    "startingWork.workflow.currentActor": "المعتمد الحالي",
    "startingWork.workflow.action.submit": "تم الإرسال",
    "startingWork.workflow.action.approve": "تم الاعتماد",
    "startingWork.workflow.action.reject": "تم الرفض",

    // Keys that previously existed only in English
    "leave.reasonReqTitle": "السبب مطلوب",
    "leave.reasonReqDesc": "يرجى ذكر سبب الرفض.",
    "leave.rejectFail": "تعذر رفض الطلب",
    "leave.rejectSuccess": "تم رفض الطلب",
    "leave.rejectError": "حدث خطأ في النظام أثناء الرفض",
    "leave.loadingDetails": "جارٍ تحميل تفاصيل الطلب...",
    "leave.loadFail": "تعذر تحميل تفاصيل الطلب",
    "leave.notFound": "غير موجود",
    "leave.notFoundDesc": "لم يتم العثور على طلب الإجازة.",
    "cfo.dashboard.title": "لوحة تحكم المدير المالي",
    "cfo.dashboard.subtitle":
      "نظرة عامة على الطلبات المعلّقة التي تتطلب موافقة المدير المالي.",
    "cfo.dashboard.pendingLoanRequests": "طلبات السلف المعلّقة",
    "cfo.dashboard.viewLoanRequests": "عرض طلبات السلف",
    "cfo.dashboard.quickActions": "إجراءات سريعة",
    "cfo.dashboard.reviewLoans": "مراجعة السلف",
    "import.history.title": "سجل الاستيراد",
    "import.history.downloadFail": "تعذر تنزيل ملف الأخطاء",
    "import.history.uploadedBy": "رُفع بواسطة",
    "import.history.totalRows": "إجمالي الصفوف",
    "import.history.inserted": "المُدرجة",
    "import.history.downloadError": "تنزيل ملف الأخطاء",
    "import.history.filterStatus": "تصفية حسب الحالة",
    "import.history.success": "ناجح",
    "import.history.failed": "فاشل",
    "import.history.processing": "قيد المعالجة",
    "import.result.loadFail": "تعذر تحميل نتيجة الاستيراد",
    "import.result.loading": "جارٍ تحميل حالة الاستيراد...",
    "import.result.wrong": "حدث خطأ ما",
    "import.result.noDetails": "تعذر جلب تفاصيل الاستيراد.",
    "import.result.successTitle": "اكتمل الاستيراد بنجاح",
    "import.result.failedTitle": "فشل الاستيراد",
    "import.result.processingTitle": "جارٍ معالجة الاستيراد...",
    "import.result.successDesc":
      "تم إدراج {inserted} من أصل {total} موظف بنجاح.",
    "import.result.processingDesc":
      "جارٍ معالجة ملفك. يمكنك تحديث هذه الصفحة أو العودة لاحقًا.",
    "import.result.failedDesc": "حدث خطأ واحد أو أكثر، ولم يتم حفظ أي بيانات.",
    "import.result.uploadNew": "رفع ملف جديد",
    "import.result.viewHistory": "عرض السجل",
    "import.result.alertTitle": "استيراد كامل أو لا شيء",
    "import.result.alertDesc":
      "بسبب وجود أخطاء، تم رفض عملية الاستيراد بالكامل لتجنّب حفظ بيانات جزئية.",
    "import.result.downloadError": "تنزيل تقرير الأخطاء التفصيلي (.xlsx)",
    "import.result.errorSummary": "ملخص الأخطاء",

    // Asset return workflow & asset statuses
    "assets.approvalMap.eyebrow": "مسار إرجاع العهدة",
    "assets.approvalMap.title": "تقدّم الموافقات",
    "assets.approvalMap.submitted": "تم التقديم",
    "assets.approvalMap.requestSent": "تم تقديم طلب الإرجاع.",
    "assets.approvalMap.managerReview": "مراجعة المدير المباشر",
    "assets.approvalMap.notRequired": "غير مطلوب",
    "assets.approvalMap.hrReview": "مراجعة الموارد البشرية",
    "assets.approvalMap.approvedForReturn": "جاهز لمعالجة الموارد البشرية.",
    "assets.approvalMap.ceoReview": "مراجعة الرئيس التنفيذي",
    "assets.approvalMap.processed": "تمت معالجة الإرجاع",
    "assets.approvalMap.returnCompleted": "تمت معالجة إرجاع العهدة.",
    "assets.approvalMap.awaitingHandOff":
      "بانتظار استلام الموارد البشرية للعهدة.",
    "assets.returnRequest": "طلب إرجاع",
    "assets.returnRequested": "تم تقديم طلب الإرجاع",
    "assets.returnRequestApproved": "تمت الموافقة على طلب الإرجاع",
    "assets.returnRequestRejected": "تم رفض طلب الإرجاع",
    "assets.searchPlaceholder": "ابحث برمز العهدة أو الرقم التسلسلي أو الاسم",
    "assets.requestsHistory": "سجل الطلبات",
    "assets.filterRequestsByAsset": "تصفية حسب العهدة",
    "assets.allAssets": "جميع العهد",
    "assets.requestHistoryUnavailable": "تعذر تحميل سجل الطلبات",
    "assets.decision": "القرار",
    "assets.status.AVAILABLE": "متاحة",
    "assets.status.ASSIGNED": "مسلّمة",
    "assets.status.UNDER_MAINTENANCE": "تحت الصيانة",
    "assets.status.LOST": "مفقودة",
    "assets.status.DAMAGED": "تالفة",
    "assets.status.RETIRED": "مستبعدة",
    "assets.requestStatus.PENDING_MANAGER": "بانتظار المدير المباشر",
    "assets.requestStatus.PENDING": "قيد الانتظار",
    "assets.requestStatus.PENDING_HR": "بانتظار الموارد البشرية",
    "assets.requestStatus.PENDING_CEO": "بانتظار الرئيس التنفيذي",
    "assets.requestStatus.APPROVED": "موافق عليه",
    "assets.requestStatus.PROCESSED": "تمت المعالجة",
    "assets.requestStatus.REJECTED": "مرفوض",
    "hr.assets.lookup.invalidLabel": "ملصق العهدة غير صالح أو منتهي الصلاحية.",
    "hr.assets.nameEnPlaceholder": "الاسم (بالإنجليزية)",
    "hr.assets.removeCustomDetail": "إزالة التفصيل المخصص",

    // Generic workflow
    "workflow.noUpdate": "لا يوجد تحديث بعد",
    "workflow.currentAction": "بانتظار الإجراء",
    "workflow.systemActor": "النظام",
    "workflow.approvalNotePlaceholder": "أضف ملاحظة على الموافقة",
    "workflow.action.submit": "تم التقديم",
    "workflow.action.approve": "تمت الموافقة",
    "workflow.action.reject": "تم الرفض",
    "workflow.action.cancel": "تم الإلغاء",
    "workflow.action.request_changes": "طُلبت تعديلات",
    "workflow.action.advance": "انتقل إلى المرحلة التالية",
    "workflow.action.reassign": "أُعيد الإسناد",
    "workflow.action.override": "تم التجاوز",
    "workflow.action.delegate": "تم التفويض",

    // Shared UI
    "archive.extractionQueued": "تمت جدولة استخراج بيانات المستند.",
    "archive.runExtraction": "تشغيل استخراج النص (OCR)",
    "layout.whatsappIntegration": "تكامل واتساب",
    "common.columns": "الأعمدة",
    "common.saving": "جارٍ الحفظ...",
    "common.saved": "تم الحفظ",
    "common.savedAutomatically": "تم الحفظ تلقائيًا",
    "common.notFound": "غير موجود",
    "common.jobTitle": "المسمى الوظيفي",
    "common.nameAr": "الاسم (بالعربية)",
    "common.all": "الكل",
    "common.totalItems": "الإجمالي: {total}",
    "common.copy": "نسخ",
    "common.copied": "تم النسخ!",
    "common.user": "مستخدم",
    "common.perPage": "{count} / صفحة",
    "common.rateLimited": "يرجى الانتظار قبل المحاولة مرة أخرى.",
    ...
    "common.error.checkInput":
      "يرجى مراجعة البيانات المدخلة والمحاولة مرة أخرى.",
    "common.error.unexpectedResponse": "وردت استجابة غير متوقعة من الخادم.",
    "common.error.unexpected": "حدث خطأ غير متوقع",
    "common.error.requestFailed": "تعذر إتمام الطلب",
    "error.loadData": "تعذر تحميل البيانات",
    "error.renderFailed": "حدث خطأ غير متوقع أثناء عرض هذه الصفحة.",
    "error.reloadPage": "إعادة تحميل الصفحة",
    "error.technicalDetails": "التفاصيل التقنية",
    "loading.checkingAccess": "جارٍ التحقق من الصلاحيات...",
    "loading.verifyingSession": "جارٍ التحقق من الجلسة...",

    // Admin: users, audit, invites
    "admin.users.readOnly": "للقراءة فقط",
    "admin.users.companyAccess": "الوصول إلى الشركات",
    "admin.users.companyAccessHint":
      "اختر الشركات وسياقات المكتب الرئيسي التي يمكن لهذا المستخدم التبديل بينها.",
    "admin.users.selectCompanies": "اختر الشركات",
    "admin.users.allCompanies": "جميع الشركات",
    "admin.users.noCompanyAccess": "لا يوجد وصول إلى أي شركة",
    "admin.users.manageCompanies": "إدارة",
    "admin.users.manageCompaniesTitle": "إدارة الشركات",
    "admin.users.manageCompaniesFor": "إدارة وصول الشركات للمستخدم",
    "admin.users.allStatuses": "جميع الحالات",
    "admin.users.countOne": "مستخدم واحد",
    "admin.users.countOther": "{count} مستخدم",
    "admin.users.resetModeTemporary": "كلمة مرور مؤقتة",
    "admin.users.resetModeLink": "رمز رابط إعادة التعيين",
    "admin.users.resetDone":
      "تمت إعادة تعيين كلمة المرور بنجاح، وأُرسلت بيانات الدخول بشكل آمن.",
    "admin.audit.colTarget": "الهدف",
    "admin.audit.colIp": "عنوان IP",
    "admin.audit.exported": "تم التصدير بصيغة {format}.",
    "admin.audit.exportFailed": "تعذر التصدير بصيغة {format}.",
    "admin.invites.sendFailed": "تعذر إرسال الدعوة.",
    "admin.invites.sentSuccess": "تم إرسال الدعوة بنجاح.",
    "admin.invites.channelLabelWhatsapp": "رسالة واتساب",
    "admin.invites.channelLabelEmail": "البريد الإلكتروني",
    "admin.invites.createdNotDelivered":
      "تم إنشاء الدعوة، لكن لم يتم تسليم {channel}.",
    "admin.invites.createdNotDeliveredWithError":
      "تم إنشاء الدعوة، لكن لم يتم تسليم {channel}: {error}",
    "admin.invites.updatedNotDelivered":
      "تم تحديث الدعوة، لكن لم يتم تسليم {channel}.",
    "admin.invites.updatedNotDeliveredWithError":
      "تم تحديث الدعوة، لكن لم يتم تسليم {channel}: {error}",
    "admin.invites.resending": "جارٍ إعادة إرسال الدعوة...",
    "admin.invites.resendFailed": "تعذرت إعادة الإرسال.",
    "admin.invites.resent": "تمت إعادة إرسال الدعوة.",
    "admin.invites.revoking": "جارٍ سحب الدعوة...",
    "admin.invites.revokeFailed": "تعذر سحب الدعوة.",
    "admin.invites.revoked": "تم سحب الدعوة.",

    // Admin: WhatsApp integration
    "admin.whatsapp.subtitle": "ربط الجهاز عبر Evolution API واختبار الإرسال",
    "admin.whatsapp.status.checking": "جارٍ التحقق",
    "admin.whatsapp.status.notConfigured": "غير مُهيّأ",
    "admin.whatsapp.status.connected": "متصل",
    "admin.whatsapp.status.open": "متصل",
    "admin.whatsapp.status.disconnected": "غير متصل",
    "admin.whatsapp.status.close": "غير متصل",
    "admin.whatsapp.status.connecting": "جارٍ الاتصال",
    "admin.whatsapp.status.qr": "بانتظار مسح رمز QR",
    "admin.whatsapp.status.unreachable": "تعذر الوصول",
    "admin.whatsapp.loadStatusFailed": "تعذر تحميل حالة واتساب.",
    "admin.whatsapp.noQrReturned":
      "لم يتم إرجاع رمز QR. حدّث الحالة بعد بضع ثوانٍ.",
    "admin.whatsapp.connectFailed": "تعذر بدء الاتصال بواتساب.",
    "admin.whatsapp.noQrAvailable": "لا يتوفر رمز QR حاليًا.",
    "admin.whatsapp.refreshQrFailed": "تعذر تحديث رمز QR.",
    "admin.whatsapp.disconnected": "تم فصل جهاز واتساب.",
    "admin.whatsapp.disconnectFailed": "تعذر فصل جهاز واتساب.",
    "admin.whatsapp.devicePairing": "ربط الجهاز",
    "admin.whatsapp.instance": "المثيل: {name}",
    "admin.whatsapp.notSet": "غير محدد",
    "admin.whatsapp.generateQr": "إنشاء رمز QR",
    "admin.whatsapp.refreshQr": "تحديث رمز QR",
    "admin.whatsapp.qrAlt": "رمز QR لربط واتساب",
    "admin.whatsapp.deviceConnected": "الجهاز متصل",
    "admin.whatsapp.generateQrPrompt": "أنشئ رمز QR",
    "admin.whatsapp.canSend": "يمكن إرسال إشعارات واتساب.",
    "admin.whatsapp.scanHint":
      'امسح رمز QR من قائمة "الأجهزة المرتبطة" في واتساب.',
    "admin.whatsapp.disconnectDevice": "فصل الجهاز",
    "admin.whatsapp.configuration": "الإعدادات",
    "admin.whatsapp.apiUrl": "رابط API",
    "admin.whatsapp.apiKey": "مفتاح API",
    "admin.whatsapp.set": "مُعدّ",
    "admin.whatsapp.missing": "غير مُعدّ",
    "admin.whatsapp.providerStatus": "حالة المزوّد",
    "admin.whatsapp.sendTestTitle": "إرسال تجريبي",
    "admin.whatsapp.phoneRequired": "أدخل رقم الهاتف بالصيغة الدولية E.164.",
    "admin.whatsapp.sendTestButton": "إرسال رسالة واتساب تجريبية",

    // WhatsApp message templates
    "templates.category.whatsapp": "رسائل واتساب",
    "templates.whatsapp.previewFailed": "تعذرت معاينة رسالة واتساب.",
    "templates.whatsapp.saved": "تم حفظ قالب واتساب.",
    "templates.whatsapp.saveFailed": "تعذر حفظ قالب واتساب.",
    "templates.whatsapp.resetDone": "تمت إعادة تعيين قالب واتساب.",
    "templates.whatsapp.resetFailed": "تعذرت إعادة تعيين قالب واتساب.",
    "templates.whatsapp.phoneInvalid":
      "أدخل رقم الهاتف بالصيغة الدولية E.164، مثال: +201013530963.",
    "templates.whatsapp.testSent": "تم إرسال رسالة واتساب التجريبية.",
    "templates.whatsapp.testFailed": "فشل إرسال رسالة واتساب التجريبية.",
    "templates.whatsapp.empty": "لا توجد قوالب واتساب.",
    "templates.whatsapp.custom": "مخصص",
    "templates.whatsapp.default": "افتراضي",
    "templates.whatsapp.preview": "معاينة",
    "templates.whatsapp.reset": "إعادة تعيين",
    "templates.whatsapp.body": "نص الرسالة",
    "templates.whatsapp.previewTitle": "المعاينة",
    "templates.whatsapp.previewEmpty": 'اضغط "معاينة" لعرض رسالة نموذجية.',
    "templates.whatsapp.sendTest": "إرسال تجريبي",

    // Employees, profile, contracts
    "hr.employees.changedCompanyRedirect":
      "هذا الموظف يتبع شركة أخرى، وتمت إعادتك إلى قائمة الموظفين.",
    "hr.employees.notAvailableInSelectedCompany":
      "هذا الموظف غير متاح في الشركة المحددة حاليًا.",
    "employees.status.prehire": "قبل المباشرة",
    "employees.status.suspended": "موقوف",
    "employees.status.terminated": "منتهي الخدمة",
    "contractDecisions.finalNotification": "الإشعار النهائي",
    "profile.leaveBalances": "أرصدة الإجازات",
    "profile.leaveBalanceYear": "السنة",

    // Reference data forms
    "reference.codeMax": "يجب ألا يتجاوز الرمز {max} حرفًا",
    "reference.nameMax": "يجب ألا يتجاوز الاسم {max} حرفًا",
    "reference.optionalDescription": "وصف (اختياري)",
    "reference.departments.codePlaceholder": "مثال: ENG",
    "reference.departments.namePlaceholder": "مثال: الهندسة",
    "reference.positions.codePlaceholder": "مثال: MGR",
    "reference.positions.namePlaceholder": "مثال: مدير مشروع",
    "reference.taskGroups.codePlaceholder": "مثال: PROJ",
    "reference.taskGroups.namePlaceholder": "مثال: مهام المشاريع",
    "reference.sponsors.codePlaceholder": "مثال: SPONSOR-001",
    "reference.sponsors.namePlaceholder": "اسم الكفيل (اختياري)",
    "reference.rentTypes.codePlaceholder": "مثال: OFFICE",
    "reference.rentTypes.namePlaceholder": "مثال: إيجار مكتب",

    // Payroll & BioTime
    "payroll.status.DRAFT": "مسودة",
    "payroll.status.COMPLETED": "مكتمل",
    "payroll.status.PAID": "تم الصرف",
    "payroll.status.CANCELLED": "ملغى",
    "payroll.runDetails.payslipsUpdatedDesc":
      "تم تحديث {generated} قسيمة راتب. إجمالي القسائم: {total}.",
    "bioTime.manualSyncHint":
      "يُجري وكيل BioTime المزامنة من داخل شبكة المكتب، ولا يمكن لخوادم AWS اختبار الجهاز الخاص أو مزامنته مباشرةً.",

    // Audit log actions & entities emitted by the backend
    "audit.action.announcement_attachment_downloaded": "تنزيل مرفق إعلان",
    "audit.action.announcement_whatsapp_groups_listed": "عرض مجموعات واتساب",
    "audit.action.annual_leave_payment_ceo_approved":
      "اعتماد تسوية الإجازة السنوية (الرئيس التنفيذي)",
    "audit.action.annual_leave_payment_ceo_rejected":
      "رفض تسوية الإجازة السنوية (الرئيس التنفيذي)",
    "audit.action.annual_leave_payment_eligibility_viewed":
      "عرض أهلية تسوية الإجازة السنوية",
    "audit.action.annual_leave_payment_exported_pdf":
      "تصدير تسوية الإجازة السنوية PDF",
    "audit.action.annual_leave_payment_hr_reviewed":
      "مراجعة تسوية الإجازة السنوية (الموارد البشرية)",
    "audit.action.annual_leave_payment_submitted":
      "تقديم تسوية الإجازة السنوية",
    "audit.action.approve_ceo": "موافقة (الرئيس التنفيذي)",
    "audit.action.approve_delegate": "موافقة (الموظف البديل)",
    "audit.action.asset_damage_report_approved_ceo":
      "اعتماد بلاغ تلف (الرئيس التنفيذي)",
    "audit.action.asset_damage_report_rejected_ceo":
      "رفض بلاغ تلف (الرئيس التنفيذي)",
    "audit.action.asset_damage_reported": "الإبلاغ عن تلف عهدة",
    "audit.action.asset_label_printed": "طباعة ملصق عهدة",
    "audit.action.asset_return_request_approved_ceo":
      "اعتماد طلب إرجاع (الرئيس التنفيذي)",
    "audit.action.asset_return_request_approved_hr":
      "اعتماد طلب إرجاع (الموارد البشرية)",
    "audit.action.asset_return_request_approved_manager":
      "اعتماد طلب إرجاع (المدير المباشر)",
    "audit.action.asset_return_request_rejected_ceo":
      "رفض طلب إرجاع (الرئيس التنفيذي)",
    "audit.action.asset_return_request_rejected_hr":
      "رفض طلب إرجاع (الموارد البشرية)",
    "audit.action.asset_return_request_rejected_manager":
      "رفض طلب إرجاع (المدير المباشر)",
    "audit.action.asset_return_requested": "طلب إرجاع عهدة",
    "audit.action.asset_returned": "إرجاع عهدة",
    "audit.action.attendance.absence_detection_run": "تشغيل رصد الغياب",
    "audit.action.attendance.work_location_created": "إنشاء موقع عمل",
    "audit.action.attendance.work_location_deleted": "حذف موقع عمل",
    "audit.action.attendance.work_location_updated": "تحديث موقع عمل",
    "audit.action.biotime.mapping_created": "إنشاء ربط BioTime",
    "audit.action.biotime.mapping_deleted": "حذف ربط BioTime",
    "audit.action.biotime.mapping_updated": "تحديث ربط BioTime",
    "audit.action.complete_hr": "إكمال من الموارد البشرية",
    "audit.action.contract_decision_auto_approved": "اعتماد تلقائي لقرار العقد",
    "audit.action.contract_decision_auto_renewed": "تجديد تلقائي للعقد",
    "audit.action.contract_decision_manual_resolution_required":
      "قرار العقد يتطلب معالجة يدوية",
    "audit.action.contract_decision_rejected": "رفض قرار العقد",
    "audit.action.create_adjustment": "إنشاء تعديل رصيد",
    "audit.action.cross_company_manager_assignment_created":
      "تعيين مدير من شركة أخرى",
    "audit.action.cross_company_manager_assignment_revoked":
      "إلغاء تعيين مدير من شركة أخرى",
    "audit.action.cross_company_manager_assignment_updated":
      "تحديث تعيين مدير من شركة أخرى",
    "audit.action.delegation_rule_created": "إنشاء قاعدة موظف بديل",
    "audit.action.delegation_rule_revoked": "إلغاء قاعدة موظف بديل",
    "audit.action.delegation_rule_updated": "تحديث قاعدة موظف بديل",
    "audit.action.employee_archive_rejected": "رفض أرشفة موظف",
    "audit.action.employee_archive_requested": "طلب أرشفة موظف",
    "audit.action.employee_archived": "أرشفة موظف",
    "audit.action.employee_document_deleted": "حذف مستند موظف",
    "audit.action.employee_document_downloaded": "تنزيل مستند موظف",
    "audit.action.employee_document_expiry_whatsapp_sent":
      "إرسال تنبيه انتهاء مستند عبر واتساب",
    "audit.action.employee_document_extraction_queued":
      "جدولة استخراج بيانات مستند",
    "audit.action.employee_document_updated": "تحديث مستند موظف",
    "audit.action.employee_document_uploaded": "رفع مستند موظف",
    "audit.action.employee_manager_changed": "تغيير مدير الموظف",
    "audit.action.employee_manager_legacy_synced": "مزامنة مدير الموظف",
    "audit.action.employee_restored": "استعادة موظف",
    "audit.action.employee_signature_deleted": "حذف توقيع موظف",
    "audit.action.employee_signature_previewed": "معاينة توقيع موظف",
    "audit.action.employee_signature_replaced": "استبدال توقيع موظف",
    "audit.action.employee_work_license_expiry_whatsapp_queued":
      "جدولة تنبيه انتهاء رخصة العمل عبر واتساب",
    "audit.action.invite_resent": "إعادة إرسال دعوة",
    "audit.action.job_offer_accepted": "قبول عرض عمل",
    "audit.action.job_offer_accepted_profile_updated":
      "تحديث الملف من عرض عمل مقبول",
    "audit.action.job_offer_biotime_mapping_missing_notified":
      "إرسال تنبيه بعدم وجود ربط BioTime",
    "audit.action.job_offer_biotime_mapping_present": "تأكيد وجود ربط BioTime",
    "audit.action.job_offer_cancelled": "إلغاء عرض عمل",
    "audit.action.job_offer_ceo_copy_sent":
      "إرسال نسخة عرض العمل للرئيس التنفيذي",
    "audit.action.job_offer_created": "إنشاء عرض عمل",
    "audit.action.job_offer_cv_downloaded": "تنزيل السيرة الذاتية للمرشح",
    "audit.action.job_offer_delivery_failed": "فشل تسليم عرض العمل",
    "audit.action.job_offer_invitation_sent": "إرسال دعوة عرض العمل",
    "audit.action.job_offer_pdf_downloaded": "تنزيل عرض العمل PDF",
    "audit.action.job_offer_rejected": "رفض عرض عمل",
    "audit.action.job_offer_sent": "إرسال عرض عمل",
    "audit.action.job_offer_submitted_for_ceo_approval":
      "تقديم عرض عمل لاعتماد الرئيس التنفيذي",
    "audit.action.job_offer_whatsapp_pdf_sent":
      "إرسال عرض العمل PDF عبر واتساب",
    "audit.action.leave_delegate_updated": "تحديث الموظف البديل للإجازة",
    "audit.action.leave_type_created": "إنشاء نوع إجازة",
    "audit.action.leave_type_deactivated": "تعطيل نوع إجازة",
    "audit.action.leave_type_updated": "تحديث نوع إجازة",
    "audit.action.loan_deducted_in_payroll": "خصم السلفة من الرواتب",
    "audit.action.loan_request_exported_pdf": "تصدير طلب سلفة PDF",
    "audit.action.loan_request_submitted": "تقديم طلب سلفة",
    "audit.action.logout": "تسجيل الخروج",
    "audit.action.manager_stage_fallback_to_hr":
      "تحويل مرحلة المدير إلى الموارد البشرية",
    "audit.action.manual_leave_record_deleted": "حذف سجل إجازة يدوي",
    "audit.action.manual_leave_record_updated": "تحديث سجل إجازة يدوي",
    "audit.action.organization_scope_created": "إنشاء نطاق مؤسسي",
    "audit.action.organization_scope_updated": "تحديث نطاق مؤسسي",
    "audit.action.password_changed": "تغيير كلمة المرور",
    "audit.action.payslip_list_viewed": "عرض قائمة قسائم الرواتب",
    "audit.action.reject_ceo": "رفض (الرئيس التنفيذي)",
    "audit.action.reject_delegate": "رفض (الموظف البديل)",
    "audit.action.rent_created": "إنشاء إيجار",
    "audit.action.rent_deleted": "حذف إيجار",
    "audit.action.rent_exported_pdf": "تصدير إيجار PDF",
    "audit.action.rent_payment_created": "تسجيل دفعة إيجار",
    "audit.action.rent_type_created": "إنشاء نوع إيجار",
    "audit.action.rent_type_deleted": "حذف نوع إيجار",
    "audit.action.rent_type_updated": "تحديث نوع إيجار",
    "audit.action.rent_updated": "تحديث إيجار",
    "audit.action.request_obligation_waived": "الإعفاء من التزام الطلب",
    "audit.action.send_to_ceo": "إرسال إلى الرئيس التنفيذي",
    "audit.action.settings_updated": "تحديث الإعدادات",
    "audit.action.starting_work_acknowledgment_approved":
      "اعتماد التحقق من مباشرة العمل",
    "audit.action.starting_work_acknowledgment_pdf_downloaded":
      "تنزيل التحقق من مباشرة العمل PDF",
    "audit.action.starting_work_acknowledgment_rejected":
      "رفض التحقق من مباشرة العمل",
    "audit.action.user_created": "إنشاء مستخدم",
    "audit.action.user_organization_access_changed":
      "تغيير وصول المستخدم للشركات",
    "audit.action.user_password_reset": "إعادة تعيين كلمة مرور مستخدم",
    "audit.action.user_role_changed": "تغيير دور مستخدم",
    "audit.action.user_status_changed": "تغيير حالة مستخدم",
    "audit.action.whatsapp_template_reset": "إعادة تعيين قالب واتساب",
    "audit.action.whatsapp_template_updated": "تحديث قالب واتساب",
    "audit.entity.AnnualLeavePaymentRequest": "تسوية الإجازة السنوية",
    "audit.entity.AssetDamageReport": "بلاغ تلف عهدة",
    "audit.entity.AssetReturnRequest": "طلب إرجاع عهدة",
    "audit.entity.ContractDecision": "قرار عقد",
    "audit.entity.EmployeeProfile": "ملف موظف",
    "audit.entity.JobOffer": "عرض عمل",
    "audit.entity.OrganizationNode": "المنشأة",
    "audit.entity.Payslip": "قسيمة راتب",
    "audit.entity.PrintedLabelJob": "مهمة طباعة ملصقات",
    "audit.entity.RequestObligation": "التزام طلب",
    "audit.entity.StartingWorkAcknowledgment": "التحقق من مباشرة العمل",
    "audit.entity.User": "المستخدم",
    "audit.entity.WhatsAppMessageTemplate": "قالب واتساب",
    "audit.entity.attendance_absence_run": "عملية رصد الغياب",
    "audit.entity.auth": "المصادقة",
    "audit.entity.biotime_employee_map": "ربط BioTime",
    "audit.entity.cross_company_manager_assignment": "تعيين مدير من شركة أخرى",
    "audit.entity.delegation_rule": "قاعدة موظف بديل",
    "audit.entity.employee_deletion_request": "طلب أرشفة موظف",
    "audit.entity.employee_document": "مستند موظف",
    "audit.entity.leave_balance_adjustment": "تعديل رصيد إجازة",
    "audit.entity.leave_type": "نوع إجازة",
    "audit.entity.organization_scope": "نطاق مؤسسي",
    "audit.entity.rent_payment": "دفعة إيجار",
    "audit.entity.rent_type": "نوع إيجار",
    "audit.entity.settings": "الإعدادات",
    "audit.entity.work_location": "موقع عمل",
    "audit.action.job_offer_ceo_approved": "اعتماد عرض عمل (الرئيس التنفيذي)",
    "audit.action.job_offer_ceo_rejected": "رفض عرض عمل (الرئيس التنفيذي)",
    "audit.action.job_offer_changes_requested": "طلب تعديلات على عرض عمل",
    "audit.action.job_offer_updated": "تحديث عرض عمل",
    "audit.action.asset_damage_report_exported_packet": "تصدير ملف بلاغ التلف",
    "audit.action.asset_damage_report_exported_pdf": "تصدير بلاغ التلف PDF",
    "audit.action.asset_return_request_exported_packet":
      "تصدير ملف طلب الإرجاع",
    "audit.action.asset_return_request_exported_pdf": "تصدير طلب الإرجاع PDF",
    "audit.action.asset_returned_auto_termination":
      "إرجاع عهدة تلقائيًا عند إنهاء الخدمة",

    // Contract decision system texts, notification milestones and deliveries
    "contractDecisions.reason.noAction":
      "لم تتخذ الموارد البشرية أي إجراء قبل انتهاء العقد.",
    "contractDecisions.reason.noActionContractChanged":
      "لم تتخذ الموارد البشرية أي إجراء قبل انتهاء العقد، لكن العقد الحالي تغيّر.",
    "contractDecisions.reason.noActionInvalidContract":
    ...
    "contractDecisions.milestone.contract.expiry": "إشعار انتهاء العقد",
    "contractDecisions.milestone.contract.expiry_milestone":
      "تذكير بانتهاء العقد",
    "contractDecisions.milestone.contract.ceo_pending": "إرسال للرئيس التنفيذي",
    "contractDecisions.milestone.contract.ceo_reminder":
      "تذكير الرئيس التنفيذي",
    ...
    "contractDecisions.milestone.contract.renewal_settlement_review_required":
      "مراجعة تسوية الإجازة عند التجديد",
    ...
    "contractDecisions.deliveryStatus.failed": "فشل",
    "contractDecisions.deliveryStatus.pending": "قيد الانتظار",
    "contractDecisions.deliveryStatus.skipped": "تم التخطي",
    "workflow.note.contractExpiryCreated": "تم إنشاء سير عمل انتهاء العقد",
    "workflow.note.autoRenewedNoHrAction":
      "تم التجديد تلقائيًا لعدم اتخاذ الموارد البشرية إجراءً",
    "layout.contractRatings": "تقييمات العقود",
    "contractDecisions.ratingSummary": "تقييم العقد",
    "contractDecisions.ratingNone": "لا يوجد تقييم عقد لهذه الدورة بعد.",
    "contractDecisions.ratingHrApproved": "اعتمدته الموارد البشرية",
    ...
    "contractRatings.employeeTitle": "التقييم الذاتي للعقد",
    "contractRatings.employeeSubtitle": "قيّم أداءك خلال فترة هذا العقد.",
    "contractRatings.loading": "جارٍ تحميل تقييم العقد…",
    "contractRatings.notFound": "تقييم العقد غير موجود أو غير متاح لك.",
    "contractRatings.forbidden": "ليس لديك صلاحية الوصول إلى تقييم العقد هذا.",
    "contractRatings.notManagerRating":
      "لست المدير المسؤول عن تقييم هذا الموظف.",
    "contractRatings.notEmployeeRating": "هذا التقييم الذاتي يخص موظفًا آخر.",
    "contractRatings.staleAction":
      "تغيّر هذا التقييم أو لم يعد بإمكانك اتخاذ إجراء عليه. تمت إعادة تحميله.",
    "contractRatings.validationTitle": "تعذّر إرسال الطلب",
    "contractRatings.actionFailed": "تعذّر إكمال الإجراء.",
    "contractRatings.resultStatus": "حالة التقييم: {status}",
    "contractRatings.submitted": "تم إرسال تقييمك.",
    "contractRatings.submit": "إرسال التقييم",
    "contractRatings.resubmit": "إعادة إرسال التقييم",
    "contractRatings.grade": "التقدير",
    "contractRatings.score": "الدرجة",
    "contractRatings.remark": "ملاحظة",
    "contractRatings.remarkPlaceholder": "ملاحظة اختيارية",
    "contractRatings.allowedRange": "النطاق المسموح: {min}–{max}",
    "contractRatings.selectGradeFirst": "اختر التقدير أولًا",
    "contractRatings.gradeRequired": "اختر التقدير وأدخل الدرجة.",
    "contractRatings.scoreOutOfRange": "أدخل عددًا صحيحًا بين {min} و{max}.",
    "contractRatings.progress": "تم إكمال {complete} من {total} معيارًا",
    "contractRatings.estimatedAverage": "معاينة المتوسط: {average} ({grade})",
    "contractRatings.estimateDisclaimer":
      "تقدير فقط. يحسب الخادم المتوسط الرسمي والتقدير العام عند الإرسال.",
    "contractRatings.overallRemark": "الملاحظة العامة",
    "contractRatings.recommendationSection": "التوصية",
    "contractRatings.recommendation": "التوصية",
    "contractRatings.recommendationRequired": "اختر توصية.",
    "contractRatings.changeTypes": "التغييرات",
    "contractRatings.changeTypesRequired": "اختر تغييرًا واحدًا على الأقل.",
    "contractRatings.salaryProposal": "مقترح الراتب",
    "contractRatings.salaryProposalHint":
      "أدخل فقط البنود التي تقترح تغييرها؛ البنود الفارغة تحتفظ بقيمتها الحالية. يحسب الخادم الإجمالي.",
    "contractRatings.salaryProposalRequired":
      "أدخل بندًا واحدًا على الأقل من الراتب المقترح.",
    "contractRatings.salaryEffectiveDate": "تاريخ سريان الراتب",
    "contractRatings.salaryEffectiveDateHint":
      "اتركه فارغًا لاستخدام اليوم التالي لانتهاء العقد.",
    "contractRatings.proposedJobTitle": "المسمى الوظيفي المقترح",
    "contractRatings.proposedPosition": "المنصب المقترح",
    "contractRatings.positionsUnavailable":
      "تعذر تحميل قائمة المناصب. يرجى إعادة المحاولة.",
    "contractRatings.otherChangeNotes": "تفاصيل التغيير الأخرى",
    "contractRatings.fieldRequired": "هذا الحقل مطلوب.",
    "contractRatings.confidentialManager":
    ...
    "contractRatings.manualResolutionNotice":
      "يحتاج هذا التقييم إلى معالجة يدوية من الموارد البشرية بسبب تغيّر العقد.",
    "contractRatings.manualResolutionHint":
      "تغيّر العقد أو ملف الموظف أو الراتب بعد بدء التقييم. لا يمكن اتخاذ إجراءات أخرى على هذا التقييم.",
    "contractRatings.employee": "الموظف",
    "contractRatings.employeeNumber": "الرقم الوظيفي",
    "contractRatings.department": "القسم",
    "contractRatings.section": "الشعبة",
    "contractRatings.jobTitle": "المسمى الوظيفي",
    "contractRatings.manager": "المدير",
    "contractRatings.contractStart": "بداية العقد",
    "contractRatings.contractExpiry": "انتهاء العقد",
    "contractRatings.evaluationPeriod": "فترة التقييم",
    "contractRatings.statusLabel": "الحالة",
    "contractRatings.criterion": "المعيار",
    "contractRatings.averageScore": "متوسط الدرجات",
    "contractRatings.overallGrade": "التقدير العام",
    "contractRatings.responseStatus": "حالة الرد",
    "contractRatings.submittedBy": "أرسله",
    "contractRatings.submittedAt": "تاريخ الإرسال",
    "contractRatings.filter": "الحالة",
    "contractRatings.empty": "لا توجد تقييمات عقود",
    "contractRatings.emptyDescription": "لا توجد تقييمات تطابق هذا المرشح.",
    "contractRatings.restrictedViewTitle": "أنت أحد المقيّمين في هذا التقييم",
    "contractRatings.restrictedViewBody":
      "لأنك مدير هذا الموظف أو الموظف نفسه، ترى جانبك فقط. يجب أن يتولى شخص آخر المراجعة والاعتماد.",
    "contractRatings.openOwnPage": "فتح تقييمي",
    "contractRatings.remainingDays": "الأيام المتبقية في العقد",
    "contractRatings.employmentStatus": "حالة التوظيف",
    "contractRatings.profileArchived": "الملف مؤرشف",
    "contractRatings.managerRecommendation": "توصية المدير",
    "contractRatings.notSubmittedYet": "لم يُرسل بعد.",
    "contractRatings.salarySection": "الراتب",
    "contractRatings.currentSalary": "الراتب الحالي",
    "contractRatings.salaryBefore": "الراتب قبل القرار",
    "contractRatings.proposedSalary": "الراتب المقترح من المدير",
    "contractRatings.ceoApprovedSalary": "الراتب المعتمد من الرئيس التنفيذي",
    "contractRatings.salaryIncrease": "الزيادة",
    "contractRatings.overrideReason": "سبب تعديل الراتب",
    "contractRatings.salaryApplied": "طُبّق على الملف",
    "contractRatings.salaryNotApplied": "لم يُطبّق",
    "contractRatings.noSalaryProposal": "لا يوجد اقتراح بتغيير الراتب.",
    "contractRatings.comparison": "المقارنة",
    "contractRatings.comparisonUnavailable":
      "تتوفر المقارنة بعد إرسال التقييمين.",
    "contractRatings.managerColumn": "المدير",
    "contractRatings.employeeColumn": "الموظف",
    "contractRatings.difference": "الفرق",
    "contractRatings.differenceHint":
      "تُبرز الفروق التي تبلغ {points} نقطة أو أكثر للانتباه فقط.",
    "contractRatings.managerAverage": "متوسط المدير",
    "contractRatings.employeeAverage": "متوسط الموظف",
    "contractRatings.managerEvaluation": "تقييم المدير",
    "contractRatings.employeeEvaluation": "التقييم الذاتي للموظف",
    "contractRatings.reviewSection":
      "مراجعة الموارد البشرية وقرار الرئيس التنفيذي",
    "contractRatings.hrReviewedBy": "مراجع الموارد البشرية",
    "contractRatings.hrDecidedAt": "تاريخ مراجعة الموارد البشرية",
    "contractRatings.hrComment": "تعليق الموارد البشرية",
    "contractRatings.ceoAction": "إجراء الرئيس التنفيذي",
    "contractRatings.ceoSelectedOption": "القرار البديل",
    "contractRatings.ceoDecidedBy": "صاحب القرار",
    "contractRatings.ceoDecidedAt": "تاريخ القرار",
    "contractRatings.ceoComment": "تعليق الرئيس التنفيذي",
    "contractRatings.hrApprove": "اعتماد وإرسال للرئيس التنفيذي",
    "contractRatings.hrReturn": "إعادة للتصحيح",
    "contractRatings.hrApproveTitle": "اعتماد هذا التقييم",
    "contractRatings.hrReturnTitle": "إعادة للتصحيح",
    "contractRatings.returnTarget": "إعادة إلى",
    "contractRatings.returnReason": "السبب",
    "contractRatings.reasonRequired": "السبب مطلوب.",
    "contractRatings.optionalComment": "تعليق (اختياري)",
    "contractRatings.ceoCannotAct":
      "لا يمكنك اتخاذ قرار في هذا التقييم (مثلًا لأنك أرسلت تقييم المدير).",
    "contractRatings.ceoAcceptTitle": "قبول توصية المدير",
    "contractRatings.ceoDeclineTitle": "رفض هذا التقييم",
    "contractRatings.ceoReturnTitle": "إعادة إلى الموارد البشرية",
    "contractRatings.ceoAlternativeTitle": "الرفض واختيار بديل",
    "contractRatings.ceoReturnHint":
      "يعود التقييم إلى الموارد البشرية لمراجعة أخرى. هذا ليس قرارًا نهائيًا.",
    "contractRatings.acceptHint":
      "تُعتمد توصية المدير. لا يُطبّق أي تغيير على الراتب.",
    "contractRatings.acceptSalaryHint":
      "يُطبّق الراتب المقترح من المدير على ملف الموظف فورًا.",
    "contractRatings.acceptTerminateHint":
      "يُجدول إنهاء الخدمة في تاريخ انتهاء العقد. يبقى الموظف نشطًا حتى ذلك الحين.",
    "contractRatings.alternativeTerminateHint":
      "يُجدول إنهاء الخدمة في تاريخ انتهاء العقد؛ ولا يُطبّق أي تغيير على الراتب.",
    "contractRatings.alternativeKeepsProposal":
      "دون تعديل، يُطبّق الراتب المقترح من المدير.",
    "contractRatings.alternativeNoSalary":
      "لم يقترح المدير تغييرًا في الراتب. استخدم التعديل لتحديده.",
    "contractRatings.overrideSalary": "تحديد راتب مختلف",
    "contractRatings.overrideSalaryHint":
      "البنود الفارغة تحتفظ بالقيمة الحالية للموظف. يحسب الخادم الإجمالي.",
    "contractRatings.acknowledge": "تسجيل إبلاغ الموظف",
    "contractRatings.acknowledgeTitle": "تسجيل إشعار إنهاء الخدمة",
    "contractRatings.acknowledgeBody":
      "أكّد أنه تم إبلاغ الموظف بإنهاء الخدمة المجدول. هذا للتوثيق فقط ولا يغيّر تاريخ الإنهاء.",
    "contractRatings.terminationScheduled":
      "إنهاء الخدمة مجدول في {date}. يبقى الموظف نشطًا حتى ذلك الحين.",
    "contractRatings.terminationProcessed":
      "تمت معالجة إنهاء الخدمة عند نهاية العقد.",
    "contractRatings.employeeNotified": "إبلاغ الموظف",
    "contractRatings.employeeNotNotified": "لم يُسجّل بعد",
    "contractRatings.archiveReason": "سبب الإنهاء",
    "contractRatings.archiveReasonEndOfContract": "انتهاء العقد / عدم التجديد",
    "contractRatings.lastWorkingDate": "آخر يوم عمل",
    "contractRatings.processedAt": "تاريخ المعالجة",
    "contractRatings.history": "سجل سير العمل",
    "contractRatings.historyEmpty": "لم تُسجَّل أي خطوات بعد.",
    "contractRatings.status.PENDING_RESPONSES": "بانتظار التقييمين",
    "contractRatings.status.WAITING_MANAGER": "بانتظار المدير",
    "contractRatings.status.WAITING_EMPLOYEE": "بانتظار الموظف",
    "contractRatings.status.PENDING_HR": "بانتظار مراجعة الموارد البشرية",
    "contractRatings.status.PENDING_CEO": "بانتظار قرار الرئيس التنفيذي",
    "contractRatings.status.APPROVED": "معتمد",
    "contractRatings.status.REJECTED": "مرفوض",
    "contractRatings.status.MANUAL_RESOLUTION_REQUIRED": "يتطلب معالجة يدوية",
    "contractRatings.gradeLabel.EXCELLENT": "ممتاز",
    "contractRatings.gradeLabel.VERY_GOOD": "جيد جدًا",
    "contractRatings.gradeLabel.GOOD": "جيد",
    "contractRatings.gradeLabel.ACCEPTABLE": "مقبول",
    "contractRatings.gradeLabel.POOR": "ضعيف",
    "contractRatings.recommendationLabel.CONTINUE_CONTRACT": "استمرار العقد",
    "contractRatings.recommendationLabel.CONTINUE_WITH_CHANGES":
      "الاستمرار مع تغييرات",
    "contractRatings.recommendationLabel.TERMINATE": "إنهاء العقد",
    "contractRatings.changeTypeLabel.SALARY_INCREASE": "زيادة الراتب",
    "contractRatings.changeTypeLabel.JOB_TITLE_CHANGE": "تغيير المسمى الوظيفي",
    "contractRatings.changeTypeLabel.POSITION_CHANGE": "تغيير المنصب",
    "contractRatings.changeTypeLabel.OTHER": "أخرى",
    "contractRatings.ceoActionLabel.ACCEPT": "قبول",
    "contractRatings.ceoActionLabel.RETURN_TO_HR": "إعادة إلى الموارد البشرية",
    "contractRatings.ceoActionLabel.DECLINE": "رفض",
    "contractRatings.ceoActionLabel.DECLINE_WITH_ALTERNATIVE": "رفض مع بديل",
    "contractRatings.alternative.RENEW": "تجديد",
    "contractRatings.alternative.RENEW_WITH_CHANGES": "تجديد مع تغييرات",
    "contractRatings.alternative.TERMINATE": "إنهاء",
    "contractRatings.returnTargetLabel.return-manager": "المدير",
    "contractRatings.returnTargetLabel.return-employee": "الموظف",
    "contractRatings.returnTargetLabel.return-both": "كلاهما",
    "contractRatings.responseStatusLabel.SUBMITTED": "مُرسل",
    "contractRatings.responseStatusLabel.RETURNED": "مُعاد للتصحيح",
    "contractRatings.checkingPending": "جارٍ التحقق من حالة تقييم العقد...",
    "contractRatings.requiredSelfRatingTitle": "أكمل تقييمك الذاتي للمتابعة",
    "contractRatings.requiredSelfRatingDescription":
      "لديك تقييم ذاتي للعقد لم يكتمل بعد. أرسله لاستعادة الوصول إلى بقية بوابة الموظف.",
    "contractRatings.requiredManagerRatingTitle": "أكمل تقييم الموظف للمتابعة",
    "contractRatings.requiredManagerRatingDescription":
      "لديك تقييم عقد لم يكتمل بعد لأحد مرؤوسيك المباشرين. أرسله لاستعادة الوصول إلى بقية بوابة المدير.",
    "contractRatings.previewPdf": "معاينة PDF",
    "contractRatings.downloadPdf": "تنزيل PDF",
    "contractRatings.pdfFailed": "تعذر تنزيل ملف PDF لتقييم العقد.",
    "contractRatings.pdfPreviewFailed": "تعذر فتح معاينة ملف PDF لتقييم العقد.",
    "contractRatings.status.PENDING_HR_GATE": "بانتظار توجيه الموارد البشرية",
    "contractRatings.status.DECIDED": "تم اتخاذ القرار",
    "contractRatings.ratingMode.UNDECIDED": "لم يُوجَّه بعد",
    "contractRatings.ratingMode.RATE": "بتقييم",
    "contractRatings.ratingMode.SKIP_TO_CEO": "أُرسل للرئيس التنفيذي دون تقييم",
    "contractRatings.routing": "التوجيه",
