...
export default function ManagerTeamPage() {
    ...
    const filtered = useMemo(() => {
        ...
        return data.filter((member) => {
            if (department !== ALL_DEPARTMENTS && member.department !== department) return false;
            ...
            render: (value?: string) =>
                value ? (
                    <Tag
                        ...
                        style={{ borderRadius: 999, paddingInline: 10, fontWeight: 600, marginInlineEnd: 0 }}
                    >
                        {value}
                    </Tag>
                ) : (
    ...
    return (
        <ApprovalQueuePage
            ...
            emptyTitle={
                isFiltered ? t("manager.team.noMatches") : t("manager.empty.noDirectReportsTitle")
            }
            emptyDescription={
                isFiltered ? t("manager.team.noMatchesDesc") : t("manager.empty.noDirectReportsDesc")
            }
            onRetry={() => load()}
            ...
            filters={
                <Space size={12} wrap style={{ width: "100%" }}>
                    ...
                    <Select
                        ...
                        options={[
                            { value: ALL_DEPARTMENTS, label: t("manager.team.departmentFilter") },
