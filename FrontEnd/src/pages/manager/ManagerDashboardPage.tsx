...
export default function ManagerDashboardPage() {
  ...
  const header = (
    <PageHeader
      ...
      subtitle={
        accessLoading ? undefined : managedCountLabel(t, managedEmployeeCount)
      }
      ...
      <Row gutter={gutter} align="top">
        <Col xs={24} lg={15}>
          <DashboardPanel
            ...
            description={
              totalPending > 0
                ? t("manager.dashboard.priorityQueueHint")
                : undefined
            }
            action={
              totalPending > 0 ? (
