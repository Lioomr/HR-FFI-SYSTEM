          ...
          >
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: t("changePassword.currentRequired"),
                },
              ]}
            >
              <Input.Password
            ...
            <Form.Item
              ...
              extra={
                <Text type="secondary" style={{ fontSize: 12 }}>
                  {t("changePassword.strengthError")}
                </Text>
              }
              rules={[
                ...
                () => ({
                  validator(_, value) {
                    ...
                    return Promise.reject(
                      new Error(t("changePassword.strengthError")),
                    );
                  },
                }),
              ]}
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: t("changePassword.confirmRequired"),
                },
                ({ getFieldValue }) => ({
                  validator(_, value) {
                    ...
                    return Promise.reject(
                      new Error(t("changePassword.mismatch")),
                    );
                  },
                }),
              ]}
