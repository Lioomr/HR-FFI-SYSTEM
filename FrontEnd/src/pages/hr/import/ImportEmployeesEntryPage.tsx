...
const ImportEmployeesEntryPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      message.success(
        t("import.employees.successMsg", { inserted: inserted_rows }),
      );
      ...
      if (
        ...
        Array.isArray(error.apiData.errors)
      ) {
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px" }}>
      ...
      {/* Instructions Card */}
      <Card
        title={t("import.employees.instructionsTitle")}
        style={{ marginBottom: 24 }}
      >
        <div style={{ marginBottom: 16 }}>
          ...
          <ul style={{ marginTop: 8, marginBottom: 16 }}>
            <li>
              {t("import.employees.fileFormat")} <Text code>.xlsx</Text>
            </li>
            <li>
              {t("import.employees.maxSize")} <Text code>5MB</Text>
            </li>
            <li>
              {t("import.employees.maxRows")} <Text code>5,000</Text>
            </li>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <ul style={{ marginTop: 8, marginBottom: 16 }}>
            <li>
              {t("import.employees.autoCreateDesc")}{" "}
              <Text type="success">
                {t("import.employees.autoCreatedLabel")}
              </Text>
            </li>
        ...
        <Button
          ...
          onClick={async () => {
            try {
              ...
              triggerBlobDownload(blob, "employee_import_template.xlsx");
      ...
      <Card title={t("import.employees.uploadTitle")}>
        <Dragger
          {...uploadProps}
          disabled={uploading || isHeadOffice}
          style={{ padding: 20 }}
        >
        ...
        <div style={{ marginTop: 24, textAlign: "right" }}>
          ...
          >
            {uploading
              ? t("import.employees.processing")
              : t("import.employees.start")}
          </Button>
        </div>
      </Card>
    </div>
