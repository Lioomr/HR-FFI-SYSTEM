...
export default function EmployeeLeaveBalances({
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "used_days",
      render: (val: any) => (
        <span style={{ color: "orange" }}>{formatLeaveDays(val)}</span>
      ),
    },
    {
        ...
        <Form layout="vertical" form={form} onFinish={handleAdjust}>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: t("hr.employees.balances.selectLeaveType"),
              },
            ]}
          >
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: t("hr.employees.balances.enterDays") },
            ]}
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: t("hr.employees.balances.reasonRequired"),
              },
            ]}
          >
            <Input.TextArea
              rows={3}
              placeholder={t("hr.employees.balances.reasonPlaceholder")}
            />
          </Form.Item>
