...
export default function RecentActivityPage() {
  ...
  const actionOptions = [
    ...
    {
      label: t("audit.action.check_in", "Check In"),
      value: "attendance.check_in",
    },
    {
      label: t("audit.action.check_out", "Check Out"),
      value: "attendance.check_out",
    },
    {
      label: t("audit.action.employee_profile_created", "Create Employee"),
      value: "employee_profile_created",
    },
    {
      label: t("audit.action.employee_profile_updated", "Update Employee"),
      value: "employee_profile_updated",
    },
    {
      label: t("audit.action.leave_request_submitted", "Leave Request"),
    ...
    <div style={{ maxWidth: 1600, margin: "0 auto", paddingBottom: 40 }}>
      <div style={{ marginBottom: 24 }}>
        <Title level={3} style={{ margin: 0 }}>
          {t("hr.dashboard.recentActivity", "Recent Activity")}
        </Title>
        <Text type="secondary">
          {t(
      ...
      >
        ...
        <Table
          ...
          pagination={{
            ...
            showTotal: (total) =>
              t("common.totalItems", { total: total.toString() }),
          }}
