...
When `Accept-Language: ar` is sent by the client, the error payload is scanned
recursively and matching strings are replaced using this dictionary.
"""
...
ARABIC_ERRORS = {
    ...
    "document": "المستند",
    "manual_entry_reason": "سبب الإدخال",
    "source_document_ref": "مرجع المستند المصدر",
    "non_field_errors": "أخطاء عامة",
    "Annual leave can be used only after completing 6 months of service.": "يمكن استخدام الإجازة السنوية فقط بعد إكمال 6 أشهر من الخدمة.",
    "Annual leave exceeds remaining balance ": "تتجاوز الإجازة السنوية الرصيد المتبقي ",
    "Annual leave exceeds available balance ": "تتجاوز الإجازة السنوية الرصيد المتاح ",
    ...
    "Only active employees are allowed.": "يسمح فقط للموظفين النشطين.",
    "Leave type is inactive.": "نوع الإجازة غير نشط.",
    "manual_entry_reason is required.": "سبب الإدخال مطلوب.",
    "source_document_ref is required.": "مرجع المستند المصدر مطلوب.",
