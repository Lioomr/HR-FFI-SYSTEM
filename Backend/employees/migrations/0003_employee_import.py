    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("errors_file", models.FileField(blank=True, null=True, storage=PrivateUploadStorage(), upload_to="employee_imports/errors/")),
                ...
                ("uploader", models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="employee_imports", to=settings.AUTH_USER_MODEL)),
            ],
            options={
                "ordering": ["-created_at"],
