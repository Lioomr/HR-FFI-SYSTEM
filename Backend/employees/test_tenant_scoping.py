...
class TenantScopeRegressionTests(APITestCase):
    ...
    def test_attendance_assets_documents_dashboard_and_notifications_are_scoped(self):
        ...
        BioTimeEmployeeMap.objects.create(employee_profile=self.athroya_employee, biotime_emp_code="ATH-SCOPE-BT")
        BioTimeEmployeeMap.objects.create(employee_profile=self.aseco_employee, biotime_emp_code="ASE-SCOPE-BT")
