...
from .views import (
    AssetViewSet,
    CEOAssetDamageReportViewSet,
    CEOAssetReturnRequestViewSet,
    ManagerAssetReturnRequestViewSet,
)
...
router.register(
    r"assets/manager/return-requests", ManagerAssetReturnRequestViewSet, basename="manager-asset-return-requests"
)
