...
from payroll.models import PayrollRun, PayrollRunItem, Payslip
...
def run_test():
    ...
    expected_gross = Decimal("5000") + Decimal("500") + Decimal("1000") + Decimal("100") + Decimal("200") + Decimal("50")
