"""Build the approved Level 2 blank notice design asset.
...
REFERENCE = OUT / "approved-level-2-style-reference.png"
PDF = OUT / "late_attendance_level_2_blank.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("Late Attendance Notice Level 2 Blank Template")
