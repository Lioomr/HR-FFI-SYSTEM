"""Build the approved Level 3 blank notice design asset.
...
REFERENCE = OUT / "approved-level-3-style-reference.png"
PDF = OUT / "late_attendance_level_3_blank.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("Late Attendance Notice Level 3 Blank Template")
